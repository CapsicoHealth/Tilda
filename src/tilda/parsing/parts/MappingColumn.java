...
public class MappingColumn
  {
    ...
    public boolean Validate(ParserSession PS, Mapper ParentMapper)
    {
      ...
      _IdColumn    = new Column("id"   , _Id   ._TypeStr, _Id   ._Size, false, null, true , null, "The original id of this type");
      _NameColumn  = new Column("name" , _Name ._TypeStr, _Name ._Size, false, null, false, null, "The mapped name for this type");
      
      if (_Group != null)
       _GroupColumn = new Column("group", _Group._TypeStr, _Group._Size, false, null, false, null, "The mapped group for this type");
