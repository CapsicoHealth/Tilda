    ...
    public boolean validate(ParserSession PS, Schema ParentSchema, int pos)
      {
        ...
        Column C = new Column("id", _Id._TypeStr, _Id._Size, false, false, ColumnMode.NORMAL, true, null, "The id for this enumeration.", _Id._Precision, _Id._Scale, null, null);
        O._Columns.add(C);
        
        C = new Column("value", _Value._TypeStr, _Value._Size, false, false, ColumnMode.NORMAL, false, null, "The value for this enumeration.", _Value._Precision, _Value._Scale, null, null);
        O._Columns.add(C);
