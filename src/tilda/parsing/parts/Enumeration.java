    ...
    public boolean validate(ParserSession PS, Schema ParentSchema, int pos)
      {
        ...
        Column C = new Column("id", _Id._TypeStr, _Id._Size, false, ColumnMode.NORMAL, true, null, "The id for this enumeration.", _Id._Precision, _Id._Scale, null);
        O._Columns.add(C);
        
        C = new Column("value", _Value._TypeStr, _Value._Size, false, ColumnMode.NORMAL, false, null, "The value for this enumeration.", _Value._Precision, _Value._Scale, null);
        O._Columns.add(C);
        
        C = new Column("label", ColumnType.STRING.toString(), 254, false, ColumnMode.NORMAL, false, ProtectionType.ABSOLUTE, "The label for this enumeration.", null, null, null);
        O._Columns.add(C);
        
        C = new Column("deactivated", ColumnType.DATETIME.toString(), null, true, ColumnMode.NORMAL, false, null, "The label for this enumeration.", null, null, null);
