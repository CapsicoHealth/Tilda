...
public abstract class ExporterRecordProcessor implements RecordProcessor
  {
     ...
     * @param logFreq
     */
    public ExporterRecordProcessor(Writer out, String outName, long logFreq)
      {
        _out = out;
        _totalCount = 0;
        _logFreq = logFreq;
     ...
     */
    public ExporterRecordProcessor(String outFile, long logFreq)
      throws FileNotFoundException
      {
