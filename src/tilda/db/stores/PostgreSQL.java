    ...
    protected static void PrintFunctionIn(StringBuilder Str, String Type)
     {
       Str.append("DROP FUNCTION IF EXISTS TILDA.In("+Type+", "+Type+"[]);\n")
          .append("CREATE OR REPLACE FUNCTION TILDA.In(val "+Type+", vals "+Type+"[]) RETURNS boolean AS $$\n")
          .append("DECLARE\n")
          .append("  str "+Type+";\n")
          .append("BEGIN\n")
          .append("  IF vals is not null THEN\n")
          .append("    FOREACH str IN ARRAY vals LOOP\n")
          .append("      IF str = val THEN\n")
          .append("        RETURN true;\n")
          .append("      END IF;\n")
          .append("    END LOOP;\n")
          .append("  END IF;\n")
    ...
    public boolean addHelperFunctions(Connection Con) throws Exception
     {
       ...
       Str.append("DROP FUNCTION IF EXISTS TILDA.ArrayLike(text[], text);\n")
          .append("CREATE OR REPLACE FUNCTION TILDA.ArrayLike(vals text[], v text) RETURNS boolean AS $$\n")
          .append("DECLARE\n")
          .append("  str text;\n")
          .append("BEGIN\n")
          .append("  IF vals is not null THEN\n")
          .append("    v := replace(replace(v, '%', '.*'), '_', '.');\n")
          .append("    FOREACH str IN ARRAY vals LOOP\n")
          .append("      IF str ~* v THEN\n")
          .append("        RETURN true;\n")
          .append("      END IF;\n")
          .append("    END LOOP;\n")
          .append("  END IF;\n")
          ...
          .append("BEGIN\n")
          .append("  IF vals is not null THEN\n")
          .append("    FOREACH str2 IN ARRAY v LOOP\n")
          .append("      v[i] := replace(replace(v[i], '%', '.*'), '_', '.');\n")
          .append("      i := i+1;\n")
          .append("    END LOOP;\n")
          .append("    FOREACH str1 IN ARRAY vals LOOP\n")
          .append("      FOREACH str2 IN ARRAY v LOOP\n")
