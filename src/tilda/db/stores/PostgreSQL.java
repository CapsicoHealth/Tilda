    ...
    throws Exception
      {
        ...
        .append("COMMENT ON FUNCTION TILDA.MonthsBetween(timestamptz, timestamptz) IS 'Computes the number of full months between 2 dates ''start'' and ''end''.';\n")
        .append("\n")
        .append("\n")
        .append("CREATE OR REPLACE FUNCTION TILDA.QuartersBetween(timestamptz, timestamptz)\n")
        .append("  RETURNS float\n")
        .append("  IMMUTABLE LANGUAGE SQL AS\n")
        .append("'SELECT date_part(''year'', age($2, $1))*4+date_part(''month'', age($2, $1))/3.0+date_part(''days'', age($2, $1))/90.0;';\n")
        .append("COMMENT ON FUNCTION TILDA.QuartersBetween(timestamptz, timestamptz) IS 'Computes the number of full quarters between 2 dates ''start'' and ''end''.';\n")
        .append("\n")
        .append("\n")
