...
*/
public class JobMessage_Data extends tilda.data._Tilda.TILDA__JOBMESSAGE
 {
   protected static final Logger LOG = LogManager.getLogger(JobMessage_Data.class.getName());

   public JobMessage_Data() { }
