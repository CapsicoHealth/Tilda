...
<B>Description</B>:<BLOCKQUOTE style="border-left: 1px solid #EEE;padding-left: 5px;">A dummy Table created to generate JavaCode to handle results from the Tilda.getDependenciesDDLs() function output.</BLOCKQUOTE>
<BR>
This Table contains the following columns:<BLOCKQUOTE>
 <TABLE id="FailedDependencyDDLScripts_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid #BBB;">
...
public abstract class TILDA__FAILEDDEPENDENCYDDLSCRIPTS implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject, tilda.interfaces.JSONable, tilda.interfaces.CSVable
 {
   ...
   public final boolean write(Connection C) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data._Tilda.TILDA__2_2.handleFinally(PS, T0, TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SRCSCHEMANAME._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SRCSCHEMANAME.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SRCTVNAME._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SRCTVNAME.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SEQ._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SEQ.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DEPSCHEMANAME._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DEPSCHEMANAME.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DEPVIEWNAME._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DEPVIEWNAME.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.RESTORESCRIPT._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.RESTORESCRIPT.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.CREATED._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DELETED._Mask) == true) { TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);
           }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
      int i = 0;
     __Init = InitMode.LOOKUP;
      __Saved_srcSchemaName = _srcSchemaName = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SRCSCHEMANAME._Mask); _srcSchemaName = null; }
      __Saved_srcTVName     = _srcTVName     = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SRCTVNAME._Mask    ); _srcTVName = null; }
      __Saved_seq           = _seq           =                              RS.getInt       (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.SEQ._Mask          ); _seq = null; }
                              _depSchemaName = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DEPSCHEMANAME._Mask); _depSchemaName = null; }
                              _depViewName   = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DEPVIEWNAME._Mask  ); _depViewName = null; }
                              _restoreScript = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.RESTORESCRIPT._Mask); _restoreScript = null; }
      __Saved_created       = _created       = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.CREATED._Mask      ); _created = null; }
                              _lastUpdated   = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.LASTUPDATED._Mask  ); _lastUpdated = null; }
                              _deleted       = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__FAILEDDEPENDENCYDDLSCRIPTS_Factory.COLS.DELETED._Mask      ); _deleted = null; }
     __LookupId = 0;
   ...
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, boolean noNullArrays) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.data.FailedDependencyDDLScripts_Factory.toJSON(out, (tilda.data.FailedDependencyDDLScripts_Data) this, lead, fullObject, noNullArrays); break;
          default: throw new Exception("Unknown JSON exporter '"+exportName+"' for tilda.data.FailedDependencyDDLScripts_Factory");
        } 
    }
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown JSON sync exporter '"+exportName+"' for tilda.data.FailedDependencyDDLScripts_Factory");
    }
   public void toCSV(java.io.Writer out, String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.data.FailedDependencyDDLScripts_Factory.toCSV(out, (tilda.data.FailedDependencyDDLScripts_Data) this); break;
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.data.FailedDependencyDDLScripts_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown CSV sync exporter '"+exportName+"' for tilda.data.FailedDependencyDDLScripts_Factory");
    }
 }
