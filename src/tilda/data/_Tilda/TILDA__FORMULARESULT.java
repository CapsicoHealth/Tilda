...
/**
<TABLE id="FormulaResult_DIV" class="tables">
<SCRIPT>registerStickyHeader("FormulaResult_DIV");</SCRIPT>
<TR valign="top"><TD><H2>FormulaResult&nbsp;&nbsp;&nbsp;&nbsp;<SUP style="font-size: 70%;"><SPAN class="BackToDetails"><A href="#FormulaResult_CNT">details</A>&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><A href="#">top</A></SUP></H2></TD><TD align="right"></TD></TR>
</TABLE>
<DIV id="FormulaResult_CNT" class="content">
The Table TILDA.FormulaResult:<UL>
<LI>Is mapped to the generated Java 8/PostgreSQL Tilda classes <B>FormulaResult_Factory</B>, <B>FormulaResult_Data</B> in the package <B>tilda.data</B>.
...
<TR ><TD>1</TD><TD>formulaRefnum</TD><TD><A href="TILDA___Docs.TILDA.html#Formula_CNT">TILDA<B>&nbsp;&#8226;&nbsp;</B>Formula</A></TD><TD>refnum</TD><TD>&nbsp;</TD></TR>
</TABLE></LI>
...
This Table contains the following columns:<BLOCKQUOTE>
 <TABLE id="FormulaResult_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid #BBB;">
...
<TD>The parent formula.<TABLE border="0px" style="margin:0px;margin-left:20px;font-size:75%;"><TR><TD><B style="color:white;background-color:fuchsia;">FK</B></TD><TD>&rarr;&nbsp;<A href="TILDA___Docs.TILDA.html#Formula_CNT">TILDA<B>&nbsp;&#8226;&nbsp;</B>Formula</A>: refnum</TD></TR>
  ...
  <TR valign="top" style="background-color:#FFFFFF;">
    <TD>2&nbsp;&nbsp;</TD>
<TD align="right"><B id='FormulaResult-value_DIV' class='columns'>value</B>&nbsp;&nbsp;</TD>
...
<TD>The result value.</TD>
  ...
  <TR valign="top" style="background-color:rgba(160, 199, 234, 0.2);">
    <TD>3&nbsp;&nbsp;</TD>
<TD align="right"><B id='FormulaResult-description_DIV' class='columns'>description</B>&nbsp;&nbsp;</TD>
<TD>String&nbsp;/&nbsp;text&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="left">-&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
...
<TD>The description of the result value.</TD>
  ...
  <TR valign="top" style="background-color:#FFFFFF;">
    <TD>4&nbsp;&nbsp;</TD>
<TD align="right"><B id='FormulaResult-created_DIV' class='columns'>created</B>&nbsp;&nbsp;</TD>
<TD>ZonedDateTime&nbsp;/&nbsp;timestamptz&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="left">AUTO&nbsp;&nbsp;</TD>
<TD align="center">&#x2611;&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>The timestamp for when the record was created. (TILDA.FormulaResult)</TD>
</TR>
  <TR valign="top" style="background-color:rgba(160, 199, 234, 0.2);">
    <TD>5&nbsp;&nbsp;</TD>
<TD align="right"><B id='FormulaResult-lastUpdated_DIV' class='columns'>lastUpdated</B>&nbsp;&nbsp;</TD>
<TD>ZonedDateTime&nbsp;/&nbsp;timestamptz&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="left">AUTO&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>The timestamp for when the record was last updated. (TILDA.FormulaResult)</TD>
</TR>
  <TR valign="top" style="background-color:#FFFFFF;">
    <TD>6&nbsp;&nbsp;</TD>
<TD align="right"><B id='FormulaResult-deleted_DIV' class='columns'>deleted</B>&nbsp;&nbsp;</TD>
<TD>ZonedDateTime&nbsp;/&nbsp;timestamptz&nbsp;&nbsp;</TD>
<TD align="center">&#x2611;&nbsp;&nbsp;</TD>
<TD align="left">AUTO&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
...
public abstract class TILDA__FORMULARESULT implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject, tilda.interfaces.JSONable, tilda.interfaces.CSVable
 {
   protected transient static final Logger LOG = LogManager.getLogger(TILDA__FORMULARESULT.class.getName());

   public transient static final Class<TILDA__FORMULARESULT_Factory> FACTORY_CLASS= TILDA__FORMULARESULT_Factory.class;
   public transient static final String TABLENAME = TextUtil.print("TILDA.FormulaResult", "");

   protected TILDA__FORMULARESULT() { }
   ...
   protected void setValue(String v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        throw new Exception("Cannot set tilda.data.TILDA.FormulaResult.value to null: it's not nullable.");
       else if (v.length() > 100)
        throw new Exception("Cannot set tilda.data.TILDA.FormulaResult.value: the size "+v.length()+" is larger than the max allowed of 100: "+TextUtil.escapeDoubleQuoteWithSlash(TextUtil.toMaxLength(v, 250)));
   ...
   public void setDescription(String v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        throw new Exception("Cannot set tilda.data.TILDA.FormulaResult.description to null: it's not nullable.");
       else if (v.length() > 32000)
        throw new Exception("Cannot set tilda.data.TILDA.FormulaResult.description: the size "+v.length()+" is larger than the max allowed of 32000: "+TextUtil.escapeDoubleQuoteWithSlash(TextUtil.toMaxLength(v, 250)));
...
*/
   public boolean hasChangedDescription()
     { return __Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION._Mask); }
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Nullable</B></TD><TD>false</TD></TR>
  <TR valign="top"><TD align="right"><B>Description</B></TD><TD>The timestamp for when the record was created. (TILDA.FormulaResult)</TD></TR>
...
*/
   public boolean hasChangedCreated()
     { return __Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask); }
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Nullable</B></TD><TD>false</TD></TR>
  <TR valign="top"><TD align="right"><B>Description</B></TD><TD>The timestamp for when the record was last updated. (TILDA.FormulaResult)</TD></TR>
  <TR><TD align="right"><B>Mode</B></TD><TD>AUTO</TD></TR>
  <TR><TD align="right"><B>Invariant</B></TD><TD>false</TD></TR>
  <TR><TD align="right"><B>Protect</B></TD><TD>NONE</TD></TR>
  <TR valign="top"><TD align="right"><B>Values</B></TD><TD>
   ...
   public final void setLastUpdated(ZonedDateTime v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        throw new Exception("Cannot set tilda.data.TILDA.FormulaResult.lastUpdated to null: it's not nullable.");
       else if (v.equals(_lastUpdated) == false)
        {
          __Changes.or(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask);
          __Nulls.andNot(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask);
       _lastUpdated = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedLastUpdated()
     { return __Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask); }
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR valign="top"><TD align="right"><B>Description</B></TD><TD>The timestamp for when the record was deleted. (TILDA.FormulaResult)</TD></TR>
  <TR><TD align="right"><B>Mode</B></TD><TD>AUTO</TD></TR>
  <TR><TD align="right"><B>Invariant</B></TD><TD>false</TD></TR>
  <TR><TD align="right"><B>Protect</B></TD><TD>NONE</TD></TR>
</TABLE>
...
*/
   public final boolean isDeletedNull()
     { return __Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask); }
   ...
   public final void setDeleted(ZonedDateTime v) throws Exception
     {
       ...
       if (v == null)
        ...
        {
          __Changes.or(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask);
          __Nulls.andNot(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask);
       _deleted = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public final void setDeletedNull()
     {
       long T0 = System.nanoTime();
       if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == true) // already NULL
        return;
       __Changes.or(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask);
       __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask);
       _deleted=null;
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedDeleted()
     { return __Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask); }
   ...
   public final boolean write(Connection C) throws Exception
     {
       ...
       if (hasChanged() == false)
        {
          LOG.debug(QueryDetails._LOGGING_HEADER + "The tilda.data.TILDA.FormulaResult has not changed: no writing will occur.");
       ...
       if (beforeWrite(C) == false)
        {
          LOG.debug(QueryDetails._LOGGING_HEADER + "The tilda.data.TILDA.FormulaResult object's beforeWrite() failed.");
          QueryDetails.setLastQuery(TILDA__FORMULARESULT_Factory.SCHEMA_TABLENAME_LABEL, "");
          return false;
        }
       ...
       try
        ...
        {
          tilda.data._Tilda.TILDA__2_3.handleFinally(PS, T0, TILDA__FORMULARESULT_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
   ...
   protected String getTimeStampSignature() throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == true) S.append(DateTimeUtil.isNowPlaceholder(_created) == true ? "C" : "X");
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == true) S.append(DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? "C" : "X");
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == true) S.append(DateTimeUtil.isNowPlaceholder(_deleted) == true ? "C" : "X");
       return S.toString();
     }
   protected String getWriteQuery(Connection C) throws Exception
     {
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          S.append("insert into "); C.getFullTableVar(S, "TILDA", "FormulaResult");
          int Pos = S.length();
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.FORMULAREFNUM._Mask) == true) { TILDA__FORMULARESULT_Factory.COLS.FORMULAREFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_3._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.VALUE._Mask) == true) { TILDA__FORMULARESULT_Factory.COLS.VALUE.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_3._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION._Mask) == true) { TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_3._COMMAQUESTION);  }

          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == true) { TILDA__FORMULARESULT_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_3._COMMAQUESTION);
           }
          else { TILDA__FORMULARESULT_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S); V.append(C.getCommaCurrentTimestamp()); }
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_3._COMMAQUESTION);
           }
          else { TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S); V.append(C.getCommaCurrentTimestamp()); }
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == true) { TILDA__FORMULARESULT_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_3._COMMAQUESTION);
           }
        ...
        {
          S.append("update "); C.getFullTableVar(S, "TILDA", "FormulaResult"); S.append(" set");
          int Pos = S.length();
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.FORMULAREFNUM._Mask) == true) TILDA__FORMULARESULT_Factory.COLS.FORMULAREFNUM.getFullColumnVarForUpdate(C, S);
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.VALUE._Mask) == true) TILDA__FORMULARESULT_Factory.COLS.VALUE.getFullColumnVarForUpdate(C, S);
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION._Mask) == true) TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION.getFullColumnVarForUpdate(C, S);

          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == true)
           {
             if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true)
              { TILDA__FORMULARESULT_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S); S.append(C.getEqualCurrentTimestamp()); }
             else
              TILDA__FORMULARESULT_Factory.COLS.CREATED.getFullColumnVarForUpdate(C, S);
           }

          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == true)
           {
             if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true)
              { TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S); S.append(C.getEqualCurrentTimestamp()); }
             else
              TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED.getFullColumnVarForUpdate(C, S);
           }
          else 
           {
             TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S); S.append(C.getEqualCurrentTimestamp());
          ...
          if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == true)
           {
             if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true)
              { TILDA__FORMULARESULT_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S); S.append(C.getEqualCurrentTimestamp()); }
             else
              TILDA__FORMULARESULT_Factory.COLS.DELETED.getFullColumnVarForUpdate(C, S);
           }

          switch (__LookupId)
           {
             case 0: // PK
                S.append(" where ("); C.getFullColumnVar(S, "TILDA", "FormulaResult", "formulaRefnum"); S.append("=?");  S.append(" AND "); C.getFullColumnVar(S, "TILDA", "FormulaResult", "value"); S.append("=?");  S.append(")");
                break;
             case -77: 
             case -666: if (__Init == InitMode.CREATE) break;
       ...
       S.setLength(0);
       S = null;
       QueryDetails.setLastQuery(TILDA__FORMULARESULT_Factory.SCHEMA_TABLENAME_LABEL, Q);
       QueryDetails.logQuery("TILDA.FormulaResult", Q, toString());
   ...
   protected int populatePreparedStatement(Connection C, java.sql.PreparedStatement PS, List<java.sql.Array> AllocatedArrays) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.VALUE._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.VALUE._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _value);
        } 
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _description);
        } 
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_created) == false) PS.setTimestamp(++i, java.sql.Timestamp.from(_created.toInstant()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_lastUpdated) == false) PS.setTimestamp(++i, java.sql.Timestamp.from(_lastUpdated.toInstant()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_deleted) == false) PS.setTimestamp(++i, java.sql.Timestamp.from(_deleted.toInstant()), DateTimeUtil._UTC_CALENDAR);
        } 
       return i;
     }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   private final boolean readOne(Connection C, boolean Force) throws Exception
     {
       long T0 = System.nanoTime();
       if (__Init == InitMode.CREATE)
        throw new Exception("This TILDA.FormulaResult object is being read() after a create(), which doesn't make sense.");
       if (__Init == InitMode.READ == true && Force == false && hasChanged()==false)
        {
          LOG.debug(QueryDetails._LOGGING_HEADER + "This TILDA.FormulaResult object has already been read.");
          QueryDetails.setLastQuery(TILDA__FORMULARESULT_Factory.SCHEMA_TABLENAME_LABEL, "");
          return true;
        }
       StringBuilder S = new StringBuilder(1024);
       ...
       try
        ...
        {
          tilda.data._Tilda.TILDA__2_3.handleFinally(PS, T0, TILDA__FORMULARESULT_Factory.SCHEMA_TABLENAME_LABEL, StatementType.SELECT, count, null);
          PS = null;
        }
    }
   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
      int i = 0;
     __Init = InitMode.LOOKUP;
      __Saved_formulaRefnum = _formulaRefnum =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.FORMULAREFNUM._Mask); _formulaRefnum = null; }
      __Saved_value         = _value         = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.VALUE._Mask        ); _value = null; }
                              _description   = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.DESCRIPTION._Mask  ); _description = null; }
                              _created       = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.CREATED._Mask      ); _created = null; }
                              _lastUpdated   = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.LASTUPDATED._Mask  ); _lastUpdated = null; }
                              _deleted       = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask      ); _deleted = null; }
     __LookupId = 0;
   ...
   public String toString()
    {
      ...
      String Str = 
               ...
               + "; deleted"         + (__Nulls.intersects(TILDA__FORMULARESULT_Factory.COLS.DELETED._Mask      ) == true ? ": NULL" : ": " + DateTimeUtil.printDateTimeForJSON(getDeleted      ()))
         + ";";
   ...
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, boolean noNullArrays) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.data.FormulaResult_Factory.toJSON(out, (tilda.data.FormulaResult_Data) this, lead, fullObject, noNullArrays); break;
          default: throw new Exception("Unknown JSON exporter '"+exportName+"' for tilda.data.FormulaResult_Factory");
        } 
    }
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown JSON sync exporter '"+exportName+"' for tilda.data.FormulaResult_Factory");
    }
   public void toCSV(java.io.Writer out, String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.data.FormulaResult_Factory.toCSV(out, (tilda.data.FormulaResult_Data) this); break;
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.data.FormulaResult_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown CSV sync exporter '"+exportName+"' for tilda.data.FormulaResult_Factory");
    }
 }
