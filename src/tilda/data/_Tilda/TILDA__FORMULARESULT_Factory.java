          ...
          switch (LookupId)
           {
             ...
             case 1: // Query 'All'
                ...
                S.append(" order by "); C.getFullColumnVar(S, "TILDA", "FormulaResult", "formulaRefnum"); S.append(" ASC");S.append(", "); C.getFullColumnVar(S, "TILDA", "FormulaResult", "value"); S.append(" ASC");
                break;
             case -77: 
             case -666: break;
   ...
   public static int writeBatch(Connection C, List<tilda.data.FormulaResult_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_3.handleFinally(PS, T0, TILDA__FORMULARESULT_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
...
*/   static public void lookupWhereAll(Connection C, tilda.db.processors.ObjectProcessor<tilda.data.FormulaResult_Data> OP, int start, int size) throws Exception
   ...
   public static void toCSV(java.io.Writer out, List<tilda.data.FormulaResult_Data> L, boolean includeHeader) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (includeHeader == true)
        out.write(getCSVHeader() + "\n");
      for (tilda.data.FormulaResult_Data O : L)
       if (O!=null)
        {
          toCSV(out, O);
          out.write("\n");
   ...
   public static void toCSV(java.io.Writer out, tilda.data.FormulaResult_Data obj) throws java.io.IOException
    {
      long T0 = System.nanoTime();
     tilda.data._Tilda.TILDA__FORMULARESULT Obj = (tilda.data._Tilda.TILDA__FORMULARESULT) obj;
   ...
   public static void toJSON(java.io.Writer out, List<tilda.data.FormulaResult_Data> L, String lead, boolean fullList) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (fullList == true)
        {
   ...
   public static void toJSON(java.io.Writer out, tilda.data.FormulaResult_Data obj, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, "", fullObject, false);
    }

   public static void toJSON(java.io.Writer out, tilda.data.FormulaResult_Data obj, String lead, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, lead, fullObject, false);
    }

   public static void toJSON(java.io.Writer outWriter, tilda.data.FormulaResult_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
