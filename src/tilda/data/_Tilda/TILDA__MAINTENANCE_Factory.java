...
*/
     public static Type_StringPrimitive        TYPE       = new Type_StringPrimitive       (SCHEMA_LABEL, TABLENAME_LABEL, "type"       , 0/*0*/, "The type of maintenance resource to track", null, null);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
     public static Type_StringPrimitive        NAME       = new Type_StringPrimitive       (SCHEMA_LABEL, TABLENAME_LABEL, "name"       , 1/*1*/, "The name of the maintenance resource to track.", null, null);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
     public static Type_StringPrimitiveNull    VALUE      = new Type_StringPrimitiveNull   (SCHEMA_LABEL, TABLENAME_LABEL, "value"      , 2/*2*/, "The value of the maintenance resource to track.", null, null);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
          ...
          switch (LookupId)
           {
             ...
             case 1: // Query 'All'
                ...
                S.append(" order by "); C.getFullColumnVar(S, "TILDA", "Maintenance", "type"); S.append(" ASC");S.append(", "); C.getFullColumnVar(S, "TILDA", "Maintenance", "name"); S.append(" ASC");
                break;
             case -77: 
             case -666: break;
...
*/
   ...
   public static String getCSVHeader()
    {
      return "\"type\",\"name\",\"value\",\"created\",\"lastUpdated\",\"deleted\"";
    }

   public static void toCSV(java.io.Writer out, List<tilda.data.Maintenance_Data> L, boolean includeHeader) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (includeHeader == true)
        out.write(getCSVHeader() + "\n");
      for (tilda.data.Maintenance_Data O : L)
       if (O!=null)
        {
          toCSV(out, O);
          out.write("\n");
   ...
   public static void toCSV(java.io.Writer out, tilda.data.Maintenance_Data obj) throws java.io.IOException
    {
      long T0 = System.nanoTime();
   ...
   public static void toJSON(java.io.Writer out, List<tilda.data.Maintenance_Data> L, String lead, boolean fullList) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (fullList == true)
        {
   ...
   public static void toJSON(java.io.Writer out, tilda.data.Maintenance_Data obj, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, "", fullObject, false);
    }

   public static void toJSON(java.io.Writer out, tilda.data.Maintenance_Data obj, String lead, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, lead, fullObject, false);
    }

   public static void toJSON(java.io.Writer outWriter, tilda.data.Maintenance_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      org.apache.commons.io.output.StringBuilderWriter out = new org.apache.commons.io.output.StringBuilderWriter();
      tilda.data._Tilda.TILDA__MAINTENANCE Obj = (tilda.data._Tilda.TILDA__MAINTENANCE) obj;
      if (fullObject == true)
       {
          out.write(lead);
          out.write("{");
