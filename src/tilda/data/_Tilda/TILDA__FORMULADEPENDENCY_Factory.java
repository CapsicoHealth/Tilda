...
*/
     public final Type_LongPrimitive          DEPENDENCYREFNUM= new Type_LongPrimitive         (SCHEMA_LABEL, TABLENAME_LABEL, "dependencyRefnum", 1/*1*/, "The dependent formula.", null, null, null);
...
*/
     public final Type_DatetimePrimitive      CREATED         = new Type_DatetimePrimitive     (SCHEMA_LABEL, TABLENAME_LABEL, "created"         , 2/*2*/, "The timestamp for when the record was created. (TILDA.FormulaDependency)", null, null);
...
*/
     public final Type_DatetimePrimitive      LASTUPDATED     = new Type_DatetimePrimitive     (SCHEMA_LABEL, TABLENAME_LABEL, "lastUpdated"     , 3/*3*/, "The timestamp for when the record was last updated. (TILDA.FormulaDependency)", null, null);
...
*/
     public final Type_DatetimePrimitiveNull  DELETED         = new Type_DatetimePrimitiveNull (SCHEMA_LABEL, TABLENAME_LABEL, "deleted"         , 4/*4*/, "The timestamp for when the record was deleted. (TILDA.FormulaDependency)", null, null);
   }

   public static COLS_BASE COLS = new COLS_BASE();
   public static final ColumnDefinition[] COLUMNS = new ColumnDefinition[] { COLS.FORMULAREFNUM,COLS.DEPENDENCYREFNUM,COLS.CREATED,COLS.LASTUPDATED,COLS.DELETED };

   public static final ColumnDefinition[] COLUMNS_PRIMARY = new ColumnDefinition[] { COLS.FORMULAREFNUM,COLS.DEPENDENCYREFNUM };
   ...
   public static int writeBatch(Connection C, List<tilda.data.FormulaDependency_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_3.handleFinally(PS, T0, TILDA__FORMULADEPENDENCY_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
...
/**
Lookup one record by the primary key: formulaRefnum, dependencyRefnum.
*/
...
.<BR>
The results are ordered by: formulaRefnum asc, dependencyRefnum asc
...
*/   static public void lookupWhereAll(Connection C, tilda.db.processors.ObjectProcessor<tilda.data.FormulaDependency_Data> OP, int start, int size) throws Exception
   ...
   public static String getCSVHeader()
    {
      return "\"formulaRefnum\",\"dependencyRefnum\",\"created\",\"lastUpdated\",\"deleted\"";
    }

   public static void toCSV(java.io.Writer out, List<tilda.data.FormulaDependency_Data> L, boolean includeHeader) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (includeHeader == true)
        out.write(getCSVHeader() + "\n");
      for (tilda.data.FormulaDependency_Data O : L)
       if (O!=null)
        {
          toCSV(out, O);
          out.write("\n");
   ...
   public static void toCSV(java.io.Writer out, tilda.data.FormulaDependency_Data obj) throws java.io.IOException
    {
      long T0 = System.nanoTime();
     tilda.data._Tilda.TILDA__FORMULADEPENDENCY Obj = (tilda.data._Tilda.TILDA__FORMULADEPENDENCY) obj;
   ...
   public static void toJSON(java.io.Writer out, List<tilda.data.FormulaDependency_Data> L, String lead, boolean fullList) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (fullList == true)
        {
   ...
   public static void toJSON(java.io.Writer out, tilda.data.FormulaDependency_Data obj, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, "", fullObject, false);
    }

   public static void toJSON(java.io.Writer out, tilda.data.FormulaDependency_Data obj, String lead, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, lead, fullObject, false);
    }

   public static void toJSON(java.io.Writer outWriter, tilda.data.FormulaDependency_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
