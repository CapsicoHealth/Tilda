   ...
   public final boolean write(Connection C) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data._Tilda.TILDA__2_2.handleFinally(PS, T0, TILDA__KEY_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.REFNUM._Mask) == true) { TILDA__KEY_Factory.COLS.REFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.NAME._Mask) == true) { TILDA__KEY_Factory.COLS.NAME.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.MAX._Mask) == true) { TILDA__KEY_Factory.COLS.MAX.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.COUNT._Mask) == true) { TILDA__KEY_Factory.COLS.COUNT.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.CREATED._Mask) == true) { TILDA__KEY_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__KEY_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__KEY_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__KEY_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__KEY_Factory.COLS.DELETED._Mask) == true) { TILDA__KEY_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__KEY_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__2_2._COMMAQUESTION);
           }
   ...
   private final boolean readOne(Connection C, boolean Force) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data._Tilda.TILDA__2_2.handleFinally(PS, T0, TILDA__KEY_Factory.SCHEMA_TABLENAME_LABEL, StatementType.SELECT, count, null);
          PS = null;
        }
    }
