...
<SPAN onclick="onModalCloseClicked('MAPPING-type_MODAL')" class='close'>&times;</SPAN>
...
<td><a href='TILDA___Docs.TILDA.html#MAPPING_DIV'>Mapping</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING-type_DIV'>type</a> -- STRING</td>
</tr>
</table>
</DIV></DIV>
<DIV id='MAPPING-src_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('MAPPING-src_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<td><a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING_DIV'>Mapping</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING-src_DIV'>src</a> -- STRING</td>
</tr>
</table>
</DIV></DIV>
<DIV id='MAPPING-dst_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('MAPPING-dst_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<td><a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING_DIV'>Mapping</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING-dst_DIV'>dst</a> -- STRING</td>
</tr>
</table>
</DIV></DIV>
<DIV id='MAPPING-created_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('MAPPING-created_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<td><a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING_DIV'>Mapping</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING-created_DIV'>created</a> -- DATETIME</td>
</tr>
</table>
</DIV></DIV>
<DIV id='MAPPING-lastUpdated_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('MAPPING-lastUpdated_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<td><a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING_DIV'>Mapping</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING-lastUpdated_DIV'>lastUpdated</a> -- DATETIME</td>
</tr>
</table>
</DIV></DIV>
<DIV id='MAPPING-deleted_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('MAPPING-deleted_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<td><a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING_DIV'>Mapping</a></td>
<td><a href='TILDA___Docs.TILDA.html#MAPPING-deleted_DIV'>deleted</a> -- DATETIME</td>
</tr>
</table>
</DIV></DIV>
</DIV>
...
public abstract class TILDA__MAPPING implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject
 {
   protected static final Logger LOG = LogManager.getLogger(TILDA__MAPPING.class.getName());

   public static final Class<TILDA__MAPPING_Factory> FACTORY_CLASS= TILDA__MAPPING_Factory.class;
   public static final String TABLENAME = TextUtil.Print("TILDA.MAPPING", "");
   ...
   protected void setType(String v) throws Exception
     {
       ...
       if (v == null)
       ...
       else if (v.equals(_type) == false)
        {
          ...
          __Changes1 |= TILDA__MAPPING_Factory.COLS.TYPE._Mask1;
          __Nulls1   &= ~TILDA__MAPPING_Factory.COLS.TYPE._Mask1;
       _type = v;
        }
...
*/
   public boolean hasChangedType()
     { return (TILDA__MAPPING_Factory.COLS.TYPE._Mask1 & __Changes1) != 0L; }
   ...
   protected void setSrc(String v) throws Exception
     {
       ...
       if (v == null)
       ...
       else if (v.equals(_src) == false)
        {
          ...
          __Changes1 |= TILDA__MAPPING_Factory.COLS.SRC._Mask1;
          __Nulls1   &= ~TILDA__MAPPING_Factory.COLS.SRC._Mask1;
       _src = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedSrc()
     { return (TILDA__MAPPING_Factory.COLS.SRC._Mask1 & __Changes1) != 0L; }
   ...
   protected void setDst(String v) throws Exception
     {
       ...
       if (v == null)
       ...
       else if (v.equals(_dst) == false)
        {
          ...
          __Changes1 |= TILDA__MAPPING_Factory.COLS.DST._Mask1;
          __Nulls1   &= ~TILDA__MAPPING_Factory.COLS.DST._Mask1;
       _dst = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedDst()
     { return (TILDA__MAPPING_Factory.COLS.DST._Mask1 & __Changes1) != 0L; }
    ...
    void setCreated(ZonedDateTime v) throws Exception
     {
       ...
       if (v == null)
       ...
       else if (v.equals(_created) == false)
        {
          ...
          __Changes1 |= TILDA__MAPPING_Factory.COLS.CREATED._Mask1;
          __Nulls1   &= ~TILDA__MAPPING_Factory.COLS.CREATED._Mask1;
       _created = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedCreated()
     { return (TILDA__MAPPING_Factory.COLS.CREATED._Mask1 & __Changes1) != 0L; }
   ...
   public final void setLastUpdated(ZonedDateTime v) throws Exception
     {
       ...
       if (v == null)
        ...
        {
          __Changes1 |= TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1;
          __Nulls1   &= ~TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1;
       _lastUpdated = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedLastUpdated()
     { return (TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Changes1) != 0L; }
...
*/
   public final boolean isNullDeleted()
     { return (TILDA__MAPPING_Factory.COLS.DELETED._Mask1 & __Nulls1) != 0L; }
   ...
   public final void setDeleted(ZonedDateTime v) throws Exception
     {
       ...
       if (v == null)
        ...
        {
          __Changes1 |= TILDA__MAPPING_Factory.COLS.DELETED._Mask1;
          __Nulls1   &= ~TILDA__MAPPING_Factory.COLS.DELETED._Mask1;
       _deleted = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedDeleted()
     { return (TILDA__MAPPING_Factory.COLS.DELETED._Mask1 & __Changes1) != 0L; }
   ...
   public void CopyTo(tilda.data._Tilda.TILDA__MAPPING Dst) throws Exception
     {
       ...
       if ((TILDA__MAPPING_Factory.COLS.DELETED._Mask1     & __Nulls1) != 0L) Dst.setNullDeleted    (); else        Dst.setDeleted    (_deleted    );
     }
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if ((TILDA__MAPPING_Factory.COLS.TYPE._Mask1        & __Changes1) != 0L) { TILDA__MAPPING_Factory.COLS.TYPE.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if ((TILDA__MAPPING_Factory.COLS.SRC._Mask1         & __Changes1) != 0L) { TILDA__MAPPING_Factory.COLS.SRC.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if ((TILDA__MAPPING_Factory.COLS.DST._Mask1         & __Changes1) != 0L) { TILDA__MAPPING_Factory.COLS.DST.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);  }

          if ((TILDA__MAPPING_Factory.COLS.CREATED._Mask1     & __Changes1) != 0L) { TILDA__MAPPING_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append((TILDA__MAPPING_Factory.COLS.CREATED._Mask1 & __Nulls1) == 0L && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          else { TILDA__MAPPING_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S); V.append(C.getCommaCurrentTimestamp()); }
          if ((TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Changes1) != 0L) { TILDA__MAPPING_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append((TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Nulls1) == 0L && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          else { TILDA__MAPPING_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S); V.append(C.getCommaCurrentTimestamp()); }
          if ((TILDA__MAPPING_Factory.COLS.DELETED._Mask1     & __Changes1) != 0L) { TILDA__MAPPING_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append((TILDA__MAPPING_Factory.COLS.DELETED._Mask1 & __Nulls1) == 0L && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
       ...
       else // InitMode can be anything else
        {
          ...
          int Pos = S.length();
          if ((TILDA__MAPPING_Factory.COLS.TYPE._Mask1        & __Changes1) != 0L) TILDA__MAPPING_Factory.COLS.TYPE.getFullColumnVarForUpdate(C, S);
          if ((TILDA__MAPPING_Factory.COLS.SRC._Mask1         & __Changes1) != 0L) TILDA__MAPPING_Factory.COLS.SRC.getFullColumnVarForUpdate(C, S);
          if ((TILDA__MAPPING_Factory.COLS.DST._Mask1         & __Changes1) != 0L) TILDA__MAPPING_Factory.COLS.DST.getFullColumnVarForUpdate(C, S);

          if ((TILDA__MAPPING_Factory.COLS.CREATED._Mask1 & __Changes1) != 0L)
           {
             if ((TILDA__MAPPING_Factory.COLS.CREATED._Mask1 & __Nulls1) == 0L && DateTimeUtil.isNowPlaceholder(_created) == true)
          ...
          if ((TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Changes1) != 0L)
           {
             if ((TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Nulls1) == 0L && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true)
          ...
          if ((TILDA__MAPPING_Factory.COLS.DELETED._Mask1 & __Changes1) != 0L)
           {
             if ((TILDA__MAPPING_Factory.COLS.DELETED._Mask1 & __Nulls1) == 0L && DateTimeUtil.isNowPlaceholder(_deleted) == true)
       ...
       try
        {
          ...
          int i = 0;
               if ((TILDA__MAPPING_Factory.COLS.TYPE._Mask1        & __Changes1) != 0L) 
                { 
                  if ((TILDA__MAPPING_Factory.COLS.TYPE._Mask1        & __Nulls1  ) != 0L) PS.setNull(++i, java.sql.Types.CHAR   ); else PS.setString   (++i, _type);
                } 
               if ((TILDA__MAPPING_Factory.COLS.SRC._Mask1         & __Changes1) != 0L) 
                { 
                  if ((TILDA__MAPPING_Factory.COLS.SRC._Mask1         & __Nulls1  ) != 0L) PS.setNull(++i, java.sql.Types.CHAR   ); else PS.setString   (++i, _src);
                } 
               if ((TILDA__MAPPING_Factory.COLS.DST._Mask1         & __Changes1) != 0L) 
                { 
                  if ((TILDA__MAPPING_Factory.COLS.DST._Mask1         & __Nulls1  ) != 0L) PS.setNull(++i, java.sql.Types.CHAR   ); else PS.setString   (++i, _dst);
                } 
               if ((TILDA__MAPPING_Factory.COLS.CREATED._Mask1     & __Changes1) != 0L) 
                { 
                  if ((TILDA__MAPPING_Factory.COLS.CREATED._Mask1     & __Nulls1  ) != 0L) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_created) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_created.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
                } 
               if ((TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Changes1) != 0L) 
                { 
                  if ((TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask1 & __Nulls1  ) != 0L) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_lastUpdated) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_lastUpdated.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
                } 
               if ((TILDA__MAPPING_Factory.COLS.DELETED._Mask1     & __Changes1) != 0L) 
                { 
                  if ((TILDA__MAPPING_Factory.COLS.DELETED._Mask1     & __Nulls1  ) != 0L) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_deleted) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_deleted.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
                } 
   ...
   boolean Init(Connection C, java.sql.ResultSet RS) throws Exception
    {
      int i = 0;
     __Init = InitMode.LOOKUP;
      __Saved_type        = _type        = TextUtil.Trim               (RS.getString   (++i)) ;  if (RS.wasNull() == true) __Nulls1 |= TILDA__MAPPING_Factory.COLS.TYPE._Mask1       ; else _type        = _type       .trim();
      __Saved_src         = _src         = TextUtil.Trim               (RS.getString   (++i)) ;  if (RS.wasNull() == true) __Nulls1 |= TILDA__MAPPING_Factory.COLS.SRC._Mask1        ;
      __Saved_dst         = _dst         = TextUtil.Trim               (RS.getString   (++i)) ;  if (RS.wasNull() == true) __Nulls1 |= TILDA__MAPPING_Factory.COLS.DST._Mask1        ;
