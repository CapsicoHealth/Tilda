...
<B>Description</B>:<BLOCKQUOTE style="border-left: 1px solid #EEE;padding-left: 5px;">Generalized Mapping table</BLOCKQUOTE>
<BR>
This Table contains the following columns:<BLOCKQUOTE>
 <TABLE id="Mapping_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid #BBB;">
...
public abstract class TILDA__MAPPING implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject, tilda.interfaces.JSONable, tilda.interfaces.CSVable
 {
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.data.TILDA.Mapping.type</TD></TR>
...
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>src of type String</TD></TR>
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.data.TILDA.Mapping.src</TD></TR>
...
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>dst of type String</TD></TR>
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.data.TILDA.Mapping.dst</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.data.TILDA.Mapping.created</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.data.TILDA.Mapping.lastUpdated</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.data.TILDA.Mapping.deleted</TD></TR>
...
*/
   public void copyTo(tilda.data._Tilda.TILDA__MAPPING Dst) throws Exception
     {
       if (__Init == InitMode.CREATE && _type        != null)
        Dst.setType       (_type       );
       if (__Init == InitMode.CREATE && _src         != null)
        Dst.setSrc        (_src        );
       if (__Init == InitMode.CREATE && _dst         != null)
        Dst.setDst        (_dst        );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   private final boolean readOne(Connection C, boolean Force) throws Exception
     {
       ...
       StringBuilder S = new StringBuilder(1024);
          S.append("select ");
          C.getFullColumnVarList(S, TILDA__MAPPING_Factory.COLUMNS);
   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      ...
      __Saved_dst         = _dst         = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__MAPPING_Factory.COLS.DST._Mask        ); _dst = null; }
                            _created     = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__MAPPING_Factory.COLS.CREATED._Mask    ); _created = null; }
                            _lastUpdated = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__MAPPING_Factory.COLS.LASTUPDATED._Mask); _lastUpdated = null; }
                            _deleted     = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), null); if (RS.wasNull() == true) { __Nulls.or(TILDA__MAPPING_Factory.COLS.DELETED._Mask    ); _deleted = null; }
     __LookupId = 0;
   ...
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, boolean noNullArrays) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.data.Mapping_Factory.toJSON(out, (tilda.data.Mapping_Data) this, lead, fullObject, noNullArrays); break;
          default: throw new Exception("Unknown JSON exporter '"+exportName+"' for tilda.data.Mapping_Factory");
        } 
    }
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown JSON sync exporter '"+exportName+"' for tilda.data.Mapping_Factory");
    }
   public void toCSV(java.io.Writer out, String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.data.Mapping_Factory.toCSV(out, (tilda.data.Mapping_Data) this); break;
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.data.Mapping_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown CSV sync exporter '"+exportName+"' for tilda.data.Mapping_Factory");
    }
 }
