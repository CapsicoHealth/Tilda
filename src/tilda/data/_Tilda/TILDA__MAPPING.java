   ...
   public void CopyTo(tilda.data._Tilda.TILDA__MAPPING Dst) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__MAPPING_Factory.COLS.DELETED._Mask) == true) Dst.setNullDeleted    (); else        Dst.setDeleted    (_deleted    );
     }
   ...
   boolean Init(Connection C, java.sql.ResultSet RS) throws Exception
    {
      int i = 0;
     __Init = InitMode.LOOKUP;
      __Saved_type        = _type        = TextUtil.Trim               (RS.getString   (++i)) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__MAPPING_Factory.COLS.TYPE._Mask       ); else _type        = _type       .trim();
