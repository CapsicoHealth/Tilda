...
COMMENT ON COLUMN TILDA.Testing2Realized."a9TZ" IS E'Generated helper column to hold the time zone ID for ''a9''.';
COMMENT ON COLUMN TILDA.Testing2Realized."a9" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a9a1TZ" IS E'Generated helper column to hold the time zone ID for ''a9a1''.';
COMMENT ON COLUMN TILDA.Testing2Realized."a9a1" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a9bTZ" IS E'Generated helper column to hold the time zone ID for ''a9b''.';
COMMENT ON COLUMN TILDA.Testing2Realized."a9b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a9c" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a9d" IS E'The blah';
...
BEGIN
  ...
  INSERT INTO TILDA.Testing2Realized ("refnum", "name", "lastUpdated", "xxxLastUpdated", "a1", "a3b", "a4", "a4b", "a5", "a5b", "a7", "a7b", "a8", "a8bTZ", "a8b", "a9TZ", "a9", "a9a1TZ", "a9a1", "a9bTZ", "a9b", "a9c", "a9d", "description", "desc2", "desc3", "desc4", "desc5", "desc6", "a3", "bastille", "toto", "desc2_Cat1", "desc2_Cat2", "desc2_Cat3", "a7_Cat4", "a7_Cat5", "a5_null", "a6_null", "a7_null", "a8_null")
...
select TILDA.Testing2Realized."refnum" as "refnum" -- The primary key for this record
     ...
     , trim(TILDA.Testing2Realized."a8bTZ") as "a8bTZ" -- Generated helper column to hold the time zone ID for 'a8b'.
     , TILDA.Testing2Realized."a8b" as "a8b" -- The blah
     , trim(TILDA.Testing2Realized."a9TZ") as "a9TZ" -- Generated helper column to hold the time zone ID for 'a9'.
     , TILDA.Testing2Realized."a9" as "a9" -- The blah
     , trim(TILDA.Testing2Realized."a9a1TZ") as "a9a1TZ" -- Generated helper column to hold the time zone ID for 'a9a1'.
     , TILDA.Testing2Realized."a9a1" as "a9a1" -- The blah
     , TILDA.Testing2Realized."a9bTZ" as "a9bTZ" -- Generated helper column to hold the time zone ID for 'a9b'.
     , TILDA.Testing2Realized."a9b" as "a9b" -- The blah
     , TILDA.Testing2Realized."a9c" as "a9c" -- The blah
     , TILDA.Testing2Realized."a9d" as "a9d" -- The blah
     ...
     , TILDA.Testing2Realized."a3" as "a3" -- Formula column: Not A3 -- (BLOCKED IN SECONDARY VIEW FOR FORMULAS)
     , TILDA.Testing2Realized."bastille" as "bastille" -- Formula column: Bastille Day
     , TILDA.Testing2Realized."toto" as "toto" -- Formula column: Last Updated
     , TILDA.Testing2Realized."desc2_Cat1" as "desc2_Cat1" -- Formula column: desc2_Cat1 Title
     , TILDA.Testing2Realized."desc2_Cat2" as "desc2_Cat2" -- Formula column: desc2_Cat2 Title
     , TILDA.Testing2Realized."desc2_Cat3" as "desc2_Cat3" -- Formula column: desc2_Cat3 Title
     , TILDA.Testing2Realized."a7_Cat4" as "a7_Cat4" -- Formula column: a7_Cat4 Title
     , TILDA.Testing2Realized."a7_Cat5" as "a7_Cat5" -- Formula column: a7_Cat5 Title
     , TILDA.Testing2Realized."a5_null" as "a5_null" -- Formula column: Null a5
     , TILDA.Testing2Realized."a6_null" as "a6_null" -- Formula column: Null a6
     , TILDA.Testing2Realized."a7_null" as "a7_null" -- Formula column: Null a7
     , TILDA.Testing2Realized."a8_null" as "a8_null" -- Formula column: Null a8
  from TILDA.Testing2Realized
