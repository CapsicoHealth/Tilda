...
COMMENT ON COLUMN TILDA.Testing."a11" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing."a11b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing."a11c" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing."a12" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing."a12b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing."a13" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing."a13b" IS E'The blah';
...
create table if not exists TILDA.Testing2Realized -- Realized table for view TILDA.Testing2View: A test view to test .* and exclude and block.
 (  "refnum"          bigint              not null   -- The primary key for this record
  ...
  , "desc2_Cat1"      double precision               -- Formula column '<B>desc2_Cat1 Title</B>'
  , "desc2_Cat2"      double precision               -- Formula column '<B>desc2_Cat2 Title</B>'
  , "desc2_Cat3"      double precision               -- Formula column '<B>desc2_Cat3 Title</B>'
  , "a7_Cat4"         double precision               -- Formula column '<B>a7_Cat4 Title</B>'
  , "a7_Cat5"         double precision               -- Formula column '<B>a7_Cat5 Title</B>'
...
COMMENT ON COLUMN TILDA.Testing2Realized."a11" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a11b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a11c" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a12" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a12b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a13" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2Realized."a13b" IS E'The blah';
...
COMMENT ON COLUMN TILDA.Testing4Realized."a11" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4Realized."a11b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4Realized."a11c" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4Realized."a12" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4Realized."a12b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4Realized."a13" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4Realized."a13b" IS E'The blah';
...
select TILDA.Testing."refnum" as "refnum" -- The primary key for this record
     ...
     , TILDA.Testing."a11" as "a11" -- The blah
     , TILDA.Testing."a11b" as "a11b" -- The blah
     , TILDA.Testing."a11c" as "a11c" -- The blah
     , TILDA.Testing."a12" as "a12" -- The blah
     , TILDA.Testing."a12b" as "a12b" -- The blah
     , TILDA.Testing."a13" as "a13" -- The blah
     , TILDA.Testing."a13b" as "a13b" -- The blah
...
COMMENT ON COLUMN TILDA.Testing2View."a11" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2View."a11b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2View."a11c" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2View."a12" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2View."a12b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2View."a13" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing2View."a13b" IS E'The blah';
...
select TILDA.Testing2View."refnum" as "refnum" -- The primary key for this record
     ...
     , TILDA.Testing2View."a11" as "a11" -- The blah
     , TILDA.Testing2View."a11b" as "a11b" -- The blah
     , TILDA.Testing2View."a11c" as "a11c" -- The blah
     , TILDA.Testing2View."a12" as "a12" -- The blah
     , TILDA.Testing2View."a12b" as "a12b" -- The blah
     , TILDA.Testing2View."a13" as "a13" -- The blah
     , TILDA.Testing2View."a13b" as "a13b" -- The blah
...
select TILDA.Testing2Realized."refnum" as "refnum" -- The primary key for this record
     ...
     , TILDA.Testing2Realized."a11" as "a11" -- The blah
     , TILDA.Testing2Realized."a11b" as "a11b" -- The blah
     , TILDA.Testing2Realized."a11c" as "a11c" -- The blah
     , TILDA.Testing2Realized."a12" as "a12" -- The blah
     , TILDA.Testing2Realized."a12b" as "a12b" -- The blah
     , TILDA.Testing2Realized."a13" as "a13" -- The blah
     , TILDA.Testing2Realized."a13b" as "a13b" -- The blah
...
BEGIN
  ...
  INSERT INTO TILDA.Testing4Realized ("refnum", "name", "a1", "a3b", "a4", "a4b", "a5", "a5b", "a7", "a7b", "a8", "a8bTZ", "a8b", "a10a", "a10b", "a10c", "a11", "a11b", "a11c", "a12", "a12b", "a13", "a13b", "description", "desc2", "desc3", "desc4", "desc5", "desc6", "bastille", "toto", "desc2_Cat1", "desc2_Cat2", "desc2_Cat3", "a7_Cat4", "a7_Cat5", "a5_null", "a6_null", "a7_null", "a8_null", "a3", "lastUpdated")
     SELECT /*genRealizedColumnList*/"refnum" -- COLUMN
          ,"name" -- COLUMN
          -- "lastUpdated" -- BLOCKED
          -- "xxxLastUpdated" -- BLOCKED
...
COMMENT ON COLUMN TILDA.Testing4View."a11" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4View."a11b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4View."a11c" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4View."a12" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4View."a12b" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4View."a13" IS E'The blah';
COMMENT ON COLUMN TILDA.Testing4View."a13b" IS E'The blah';
