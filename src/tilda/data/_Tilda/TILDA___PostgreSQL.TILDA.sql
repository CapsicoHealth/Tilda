...
--     "a6d"  BLOCKED
     ...
     , (case when coalesce("a7", 0) >= 0.0 and coalesce("a7", 0))::double precision as "a7_Cat1"
     -- This formula checks whether the column 'a7' value falls in the range of 10.0 and 20.0.
     , (case when coalesce("a7", 0) >= 10.0 and coalesce("a7", 0))::double precision as "a7_Cat2"
...
COMMENT ON COLUMN TILDA.Testing2View."a7_Cat1" IS E'The calculated formula: This formula checks whether the column ''a7'' value falls in the range of 0.0 and 10.0.';
COMMENT ON COLUMN TILDA.Testing2View."a7_Cat2" IS E'The calculated formula: This formula checks whether the column ''a7'' value falls in the range of 10.0 and 20.0.';
...
INSERT INTO TILDA.Formula ("refnum", "location", "location2", "name", "type", "title", "description", "formula", "htmlDoc", "created", "lastUpdated", "deleted")
    VALUES (k+0, 'TILDA.Testing2View', '', 'a3', 'BOL', 'Not A3', 'Blah...', 'NOT a3', '<B>N/A</B>', current_timestamp, current_timestamp, null)
          ...
          ,(k+3, 'TILDA.Testing2View', '', 'desc2_Cat1', 'DBL', 'desc2_Cat1 Title', 'This formula checks whether the column ''desc2'' contains the values ''a'', ''b'', ''c'' for the View TILDA.Testing2View.', 'case when desc2  in (''a'', ''b'', ''c'') then 1 else 0 end', '<B>N/A</B>', current_timestamp, current_timestamp, null)
          ,(k+4, 'TILDA.Testing2View', '', 'desc2_Cat2', 'DBL', 'desc2_Cat2 Title', 'This formula checks whether the column ''desc2'' contains the values ''x'', ''y'', ''z'' for the View TILDA.Testing2View.', 'case when desc2  in (''x'', ''y'', ''z'') then 1 else 0 end', '<B>N/A</B>', current_timestamp, current_timestamp, null)
          ,(k+5, 'TILDA.Testing2View', '', 'desc2_Cat3', 'DBL', 'desc2_Cat3 Title', 'This formula checks whether the column ''desc2'' contains the values ''x'', ''y'', ''z'' for the View TILDA.Testing2View.', 'case when desc2  in (''x'', ''y'', ''z'') then 1 else 0 end', '<B>N/A</B>', current_timestamp, current_timestamp, null)
          ,(k+6, 'TILDA.Testing2View', '', 'a7_Cat1', 'DBL', 'a7_Cat1 Title', 'This formula checks whether the column ''a7'' value falls in the range of 0.0 and 10.0.', 'case when a7 >= 0.0 and a7', '<B>N/A</B>', current_timestamp, current_timestamp, null)
          ,(k+7, 'TILDA.Testing2View', '', 'a7_Cat2', 'DBL', 'a7_Cat2 Title', 'This formula checks whether the column ''a7'' value falls in the range of 10.0 and 20.0.', 'case when a7 >= 10.0 and a7', '<B>N/A</B>', current_timestamp, current_timestamp, null)
