...
create table if not exists TILDA.Testing -- blah blah
 (  "refnum"       bigint              not null   -- The primary key for this record
  ...
  , "desc2"        varchar(10)                    -- The title for a person, i.e., Mr, Miss, Mrs...
...
BEGIN
  ...
  INSERT INTO TILDA.Testing2Realized ("refnum", "name", "lastUpdated", "xxxLastUpdated", "a1", "a3b", "a4", "a4b", "a5", "a5b", "a7", "a7b", "a8", "a8bTZ", "a8b", "a10a", "a10b", "a10c", "description", "desc2", "desc3", "desc4", "desc5", "desc6", "a3", "bastille", "toto", "desc2_Cat1", "desc2_Cat2", "desc2_Cat3", "a7_Cat4", "a7_Cat5")
...
BEGIN
  ...
  INSERT INTO TILDA.Testing4Realized ("refnum", "name", "a1", "a3b", "a4", "a4b", "a5", "a5b", "a7", "a7b", "a8", "a8bTZ", "a8b", "a9TZ", "a9", "a9bTZ", "a9b", "a9c", "a9d", "a10a", "a10b", "a10c", "description", "desc2", "desc3", "desc4", "desc5", "desc6", "bastille", "toto", "desc2_Cat1", "desc2_Cat2", "desc2_Cat3", "a7_Cat4", "a7_Cat5", "a3", "lastUpdated")
     SELECT "refnum" -- COLUMN
                                               ,"name" -- COLUMN
                                               -- "lastUpdated" -- BLOCKED
                                               -- "xxxLastUpdated" -- BLOCKED
