...
public class TILDA__TESTING3VIEW_Factory
 {
   ...
   public static final String SCHEMA_TABLENAME_LABEL = TextUtil.Print("TILDA.Testing3View", "");
   public static void getFullTableNameVar(Connection C, StringBuilder S) { C.getFullTableVar(S, "TILDA", "Testing3View"); }
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing3View.a8bTZ of type varchar(10)</TD></TR>
...
*/
     public static Type_DatetimePrimitive      LASTUPDATED   = new Type_DatetimePrimitive     (SCHEMA_LABEL, TABLENAME_LABEL, "lastUpdated"   , 4/*4*/, "The timestamp for when the record was last updated. (TILDA.Testing)");
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
     public static Type_DatetimePrimitive      XXXLASTUPDATED= new Type_DatetimePrimitive     (SCHEMA_LABEL, TABLENAME_LABEL, "xxxLastUpdated", 5/*5*/, "The timestamp for when the record was last updated. (TILDA.Testing)");
;
   }
        ...
        synchronized(__INITIALIZED)
         {
           if (__INITIALIZED == false)
            {
              tilda.data.Testing3View_Factory.init(C);
              __INITIALIZED = true;
            }
         }
     }
   private static class RecordProcessorInternal implements tilda.db.processors.RecordProcessor
     {
       public RecordProcessorInternal(Connection C, int Start)
         {
           _C = C;
           _L = new ArrayListResults<tilda.data.Testing3View_Data>(Start);
         }
       public RecordProcessorInternal(Connection C, tilda.db.processors.ObjectProcessor<tilda.data.Testing3View_Data> OP)
         {
           _C = C;
           _OP = OP;
         }
       protected Connection _C = null;
       protected tilda.db.processors.ObjectProcessor<tilda.data.Testing3View_Data> _OP;
       protected ArrayListResults<tilda.data.Testing3View_Data> _L = null;
       public void    Start  () { }
       public void    End    (boolean HasMore, int Max) { if (_OP == null) _L.wrapup(HasMore, Max); }
       public boolean Process(int Index, java.sql.ResultSet RS) throws Exception
        {
          tilda.data.Testing3View_Data Obj = new tilda.data.Testing3View_Data();
          boolean OK = ((tilda.data._Tilda.TILDA__TESTING3VIEW)Obj).Init(_C, RS);
          if (OK == true)
           {
             if (_OP == null)
              _L.add(Obj);
   ...
   protected static final ListResults<tilda.data.Testing3View_Data> ReadMany(Connection C, String FullSelectQuery, int Start, int Size) throws Exception
     {
   ...
   private static final void ReadMany(Connection C, int LookupId, tilda.db.processors.RecordProcessor RP, tilda.data._Tilda.TILDA__TESTING3VIEW Obj, Object ExtraParams, int Start, int Size) throws Exception
     {
       ...
       QueryDetails.logQuery("TILDA.Testing3View", Q, null);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   public static ListResults<tilda.data.Testing3View_Data> runSelect(Connection C, SelectQuery Q, int Start, int Size) throws Exception
     {
       RecordProcessorInternal RPI = new RecordProcessorInternal(C, Start);
       ReadMany(C, -7, RPI, null, Q, Start, Size);
       return RPI._L;
     }
   public static void runSelect(Connection C, SelectQuery Q, tilda.db.processors.ObjectProcessor<tilda.data.Testing3View_Data> OP, int Start, int Size) throws Exception
     {
