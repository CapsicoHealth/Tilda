...
create table if not exists TILDA.ZoneInfo -- blah blah
 (  "id"             character(5)  not null   -- The id for this enumeration.
  ...
  , "created"        timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.ZoneInfo)
  , "lastUpdated"    timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.ZoneInfo)
...
create table if not exists TILDA.Key -- The table to keep track of unique keys across distributed objects/tables
 (  "refnum"          bigint        not null   -- The primary key for this record
  ...
  , "created"         timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created.
  , "lastUpdated"     timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated.
...
create table if not exists TILDA.Catalog -- Master catalog information
 (  "refnum"              bigint        not null   -- The primary key for this record
  ...
  , "created"             timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.Catalog)
  , "lastUpdated"         timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.Catalog)
...
create table if not exists TILDA.CatalogFormulaResult -- Master formula result information, if applicable. Some formulas may not yield an enumeratable value (e.g., returning a date)
 (  "formulaRefnum"  bigint        not null   -- The parent formula.
  ...
  , "created"        timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.CatalogFormulaResult)
  , "lastUpdated"    timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.CatalogFormulaResult)
...
create table if not exists TILDA.MaintenanceLog -- Maintenance information
 (  "refnum"       bigint         not null   -- The primary key for this record
  ...
  , "created"      timestamptz    not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.MaintenanceLog)
  , "lastUpdated"  timestamptz    not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.MaintenanceLog)
...
create table if not exists TILDA.TransPerf -- Performance logs for the Tilda framework
 (  "startPeriodTZ"           character(5)  not null   -- Generated helper column to hold the time zone ID for 'startPeriod'.
  ...
  , "created"                 timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.TransPerf)
  , "lastUpdated"             timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.TransPerf)
...
create table if not exists TILDA.RefillPerf -- Performance logs for the Tilda Refills
 (  "schemaName"      varchar(64)   not null   -- The name of the schema tracked
  ...
  , "created"         timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.RefillPerf)
  , "lastUpdated"     timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.RefillPerf)
...
create table if not exists TILDA.Mapping -- Generalized Mapping table
 (  "type"         varchar(10)    not null   -- The type this mapping is for
  ...
  , "created"      timestamptz    not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.Mapping)
  , "lastUpdated"  timestamptz    not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.Mapping)
...
create table if not exists TILDA.Connection -- Tilda DB Connections Configurations.
 (  "active"       boolean                  -- Status Flag
  ...
  , "created"      timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.Connection)
  , "lastUpdated"  timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.Connection)
...
create table if not exists TILDA.Job -- Jobs details
 (  "refnum"       bigint        not null   -- The primary key for this record
  ...
  , "created"      timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.Job)
  , "lastUpdated"  timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.Job)
...
create table if not exists TILDA.JobPart -- Job part details
 (  "refnum"        bigint        not null   -- The primary key for this record
  ...
  , "created"       timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.JobPart)
  , "lastUpdated"   timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.JobPart)
...
create table if not exists TILDA.JobPartMessage -- Job part message details
 (  "refnum"         bigint       not null   -- The primary key for this record
  ...
  , "created"        timestamptz  not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.JobPartMessage)
  , "lastUpdated"    timestamptz  not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.JobPartMessage)
...
create table if not exists TILDA.ObjectPerf -- Performance logs for the Tilda framework
 (  "schemaName"     varchar(64)   not null   -- The name of the schema tracked
  ...
  , "created"        timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.ObjectPerf)
  , "lastUpdated"    timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.ObjectPerf)
...
create table if not exists TILDA.FailedDependencyDDLScripts -- A dummy Table created to generate JavaCode to handle results from the Tilda.getDependenciesDDLs() function output.
 (  "srcSchemaName"  varchar(100)  not null   -- The result value.
  ...
  , "created"        timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.FailedDependencyDDLScripts)
  , "lastUpdated"    timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.FailedDependencyDDLScripts)
...
create table if not exists TILDA.DateDim -- The Date dimension, capturing pre-calculated metrics on dates
 (  "dt"              date          not null   -- The Date date
  ...
  , "created"         timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was created. (TILDA.DateDim)
  , "lastUpdated"     timestamptz   not null DEFAULT (statement_timestamp() at time zone 'utc')   -- The timestamp for when the record was last updated. (TILDA.DateDim)
