...
<LI>Is Realized from <B><A href="TILDA___Docs.TILDA.html#Testing2View_CNT">TILDA<B>&nbsp;&#8226;&nbsp;</B>Testing2View</A></B> through DB function <B>TILDA<B>&nbsp;&#8226;&nbsp;</B>Refill_Testing2Realized()</B>.</LI>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Formula column '<B>Not A3</B>'<DIV style="margin:0px;margin-left:20px;font-size:75%;">&nbsp;&nbsp;&rarr;&nbsp;<A href="TILDA___Docs.TILDA.html#Testing2View-a3_DIV">TILDA<B>&nbsp;&#8226;&nbsp;</B>Testing2View<B>&nbsp;&#8226;&nbsp;</B>a3</A></DIV></TD>
</TR>
  <TR valign="top" bgcolor="#DFECF8">
    <TD>33&nbsp;&nbsp;</TD>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a11 of type numeric(9,3)</TD></TR>
    ...
    void setA11(BigDecimal v) throws Exception
     {
       ...
       if (__Init == InitMode.CREATE || v != _a11)
        {
          if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
           throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a11' that is invariant, or part of a read-only or pre-existing WORM object.");
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a11b of type numeric(11,5)[]</TD></TR>
    ...
    void setA11b(List<BigDecimal> v) throws Exception
     {
       long T0 = System.nanoTime();
       if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
        throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a11b' that is invariant, or part of a read-only or pre-existing WORM object.");
       if (v == null  || v.isEmpty() == true)
        setNullA11b();
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a11c of type numeric(11,0)</TD></TR>
    ...
    void setA11c(BigDecimal v) throws Exception
     {
       ...
       if (__Init == InitMode.CREATE || v != _a11c)
        {
          if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
           throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a11c' that is invariant, or part of a read-only or pre-existing WORM object.");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//   Field tilda.data.TILDA.Testing2Realized.a12 -> TILDA.Testing2Realized."a12"
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>tilda.data.TILDA.Testing2Realized.a12 of type short</TD></TR>
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a12 of type smallint</TD></TR>
    ...
    void setA12(short v) throws Exception
     {
       ...
       if (__Init == InitMode.CREATE || v != _a12)
        {
          if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
           throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a12' that is invariant, or part of a read-only or pre-existing WORM object.");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//   Field tilda.data.TILDA.Testing2Realized.a12b -> TILDA.Testing2Realized."a12b"
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>tilda.data.TILDA.Testing2Realized.a12b of type List<Short></TD></TR>
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a12b of type smallint[]</TD></TR>
    ...
    void setA12b(List<Short> v) throws Exception
     {
       long T0 = System.nanoTime();
       if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
        throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a12b' that is invariant, or part of a read-only or pre-existing WORM object.");
       if (v == null  || v.isEmpty() == true)
        setNullA12b();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//   Field tilda.data.TILDA.Testing2Realized.a13 -> TILDA.Testing2Realized."a13"
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>tilda.data.TILDA.Testing2Realized.a13 of type uuid</TD></TR>
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a13 of type uuid</TD></TR>
    ...
    void setA13(uuid v) throws Exception
     {
       ...
       if (__Init == InitMode.CREATE || v != _a13)
        {
          if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
           throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a13' that is invariant, or part of a read-only or pre-existing WORM object.");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//   Field tilda.data.TILDA.Testing2Realized.a13b -> TILDA.Testing2Realized."a13b"
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>tilda.data.TILDA.Testing2Realized.a13b of type List<UUID></TD></TR>
  <TR><TD align="right"><B>Column</B></TD><TD>TILDA.Testing2Realized.a13b of type uuid[]</TD></TR>
    ...
    void setA13b(List<UUID> v) throws Exception
     {
       long T0 = System.nanoTime();
       if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
        throw new Exception("Cannot set field 'tilda.data.TILDA.Testing2Realized.a13b' that is invariant, or part of a read-only or pre-existing WORM object.");
       if (v == null  || v.isEmpty() == true)
        setNullA13b();
   ...
   private final boolean ReadOne(Connection C, boolean Force) throws Exception
     {
       ...
       StringBuilder S = new StringBuilder(1024);
          ...
          S.append(", "); C.getFullColumnVar(S, "TILDA", "Testing2Realized", "a12");
          S.append(", "); C.getFullColumnVar(S, "TILDA", "Testing2Realized", "a12b");
          S.append(", "); C.getFullColumnVar(S, "TILDA", "Testing2Realized", "a13");
          S.append(", "); C.getFullColumnVar(S, "TILDA", "Testing2Realized", "a13b");
   ...
   boolean Init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      __Saved_refnum         = _refnum         =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TESTING2REALIZED_Factory.COLS.REFNUM._Mask        );
                               ...
                               _a13            =                              RS.getUUID      (++i) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TESTING2REALIZED_Factory.COLS.A13._Mask           );
