...
<TD>The blah</TD>
  ...
  <TR valign="top" bgcolor="#FFFFFF">
    <TD>40&nbsp;&nbsp;</TD>
<TD onclick="onModalShowClicked('Testing-a10cTZ')" align="right"><B id='Testing-a10cTZ_DIV' class='columns dotted_underline cursor_pointer'>a10cTZ</B>&nbsp;&nbsp;</TD>
<TD>String&nbsp;/&nbsp;character(5)&nbsp;&nbsp;</TD>
<TD align="center">&#x2611;&nbsp;&nbsp;</TD>
<TD align="left">AUTO&nbsp;&nbsp;</TD>
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Generated helper column to hold the time zone ID for 'a10c'.<TABLE border="0px" style="margin:0px;margin-left:20px;font-size:75%;"><TR><TD><B style="color:white;background-color:fuchsia;">FK</B></TD><TD>&rarr;&nbsp;<A href="TILDA___Docs.TILDA.html#ZoneInfo_CNT">TILDA<B>&nbsp;&#8226;&nbsp;</B>ZoneInfo</A>: id</TD></TR>
</TABLE>
</TD>
</TR>
  <TR valign="top" bgcolor="#DFECF8">
...
<DIV id='Testing-a10a_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('Testing-a10a_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<DIV id='Testing-a10cTZ_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('Testing-a10cTZ_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
<td><a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
<td><a href='TILDA___Docs.TILDA.html#Testing_DIV'>Testing</a></td>
<td><a href='TILDA___Docs.TILDA.html#Testing-a10cTZ_DIV'>a10cTZ</a></td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr bgcolor="#DFECF8">
<td>&#9492;&#9472;<a href='TILDA___Docs.TILDA.html'>TILDA</a></td>
...
<DIV id='Testing-a10c_MODAL' class='modal'>
<DIV class='modal-content'>
<SPAN onclick="onModalCloseClicked('Testing-a10c_MODAL')" class='close'>&times;</SPAN>
<DIV><CENTER><H2>Column Dependencies</H2></CENTER></DIV>
<table style='margin: auto;'> 
  <tr> 
    <th align='left' width="300em">Schema</th> 
...
*/
   public final boolean isNullA10cTZ()
     { return __Nulls.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask); }
    ...
    void setA10cTZ(String v) throws Exception
     {
       ...
       if (v == null)
        ...
        throw new Exception("Cannot set tilda.data.TILDA.Testing.a10cTZ: the value "+TextUtil.EscapeDoubleQuoteWithSlash(v)+" is larger than the max size allowed 5.");
       else if (v.equals(_a10cTZ) == false)
        {
          __Changes.or(TILDA__TESTING_Factory.COLS.A10CTZ._Mask);
          __Nulls.andNot(TILDA__TESTING_Factory.COLS.A10CTZ._Mask);
       _a10cTZ = v;
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
    void setNullA10cTZ()
     {
       long T0 = System.nanoTime();
       if (__Nulls.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask) == true) // already NULL
        return;
       __Changes.or(TILDA__TESTING_Factory.COLS.A10CTZ._Mask);
       __Nulls.or(TILDA__TESTING_Factory.COLS.A10CTZ._Mask);
       _a10cTZ=null;
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public boolean hasChangedA10cTZ()
     { return __Changes.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask); }
...
*/
   public void setA10c(ZonedDateTime v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        {
       ...
       _a10c = v;
          tilda.data.ZoneInfo_Data ZI = tilda.data.ZoneInfo_Factory.getEnumerationByValue(v.getZone().getId());
          if (ZI == null)
           throw new Exception("Cannot set field 'tilda.data.TILDA.Testing.a10c' because the timezone value '"+v.getZone().getId()+"' is unknown. Make sure it is mapped properly in the ZoneInfo table.");
          setA10cTZ(ZI.getId());
        }
       PerfTracker.add(TransactionType.TILDA_SETTER, System.nanoTime() - T0);
     }
...
*/
   public final void setA10cNow() throws Exception
    {
      setA10c(DateTimeUtil.NOW_PLACEHOLDER_ZDT);
    }
...
*/
   public final void setA10cUndefined() throws Exception
    {
      setA10c(DateTimeUtil.UNDEFINED_PLACEHOLDER_ZDT);
    }
...
*/
   public final void setA10c(int year, int month, int date, int hourOfDay, int minute, int second, int millis, ZoneId z) throws Exception
    {
      setA10c(DateTimeUtil.New(year, month, date, hourOfDay, minute, second, millis, z));
    }
   ...
   public void CopyTo(tilda.data._Tilda.TILDA__TESTING Dst) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask) == true) Dst.setNullA10cTZ     (); else        Dst.setA10cTZ     (_a10cTZ     );
   ...
   protected String getTimeStampSignature() throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == true) S.append(DateTimeUtil.isNowPlaceholder(_a10c) == true ? "C" : "X");
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask) == true) { TILDA__TESTING_Factory.COLS.A10CTZ.getFullColumnVarForInsert(C, S); V.append(tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);  }

          if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == true) { TILDA__TESTING_Factory.COLS.A10C.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == false && DateTimeUtil.isNowPlaceholder(_a10c) == true ? C.getCommaCurrentTimestamp() : tilda.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
       ...
       else // InitMode can be anything else
        {
          ...
          if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask) == true) TILDA__TESTING_Factory.COLS.A10CTZ.getFullColumnVarForUpdate(C, S);

          if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == true)
           {
             if (__Nulls.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == false && DateTimeUtil.isNowPlaceholder(_a10c) == true)
              { TILDA__TESTING_Factory.COLS.A10C.getFullColumnVarForInsert(C, S); S.append(C.getEqualCurrentTimestamp()); }
             else
              TILDA__TESTING_Factory.COLS.A10C.getFullColumnVarForUpdate(C, S);
           }
   ...
   protected int populatePreparedStatement(Connection C, java.sql.PreparedStatement PS, List<java.sql.Array> AllocatedArrays) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTING_Factory.COLS.A10CTZ._Mask) == true) PS.setNull(++i, java.sql.Types.CHAR   ); else PS.setString   (++i, _a10cTZ);
        } 
       if (__Changes.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_a10c) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_a10c.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__TESTING_Factory.COLS.CREATED._Mask) == true) 
        { 
   ...
   boolean Init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      __Saved_refnum      = _refnum      =                              RS.getLong     (++i) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TESTING_Factory.COLS.REFNUM._Mask     );
                            ...
                            _a10cTZ      = TextUtil.Trim               (RS.getString   (++i)) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TESTING_Factory.COLS.A10CTZ._Mask     ); else _a10cTZ      = _a10cTZ     .trim();
                            _a10c        = ProcessZDT(_a10cTZ       , "tilda.data.TILDA.Testing.a10c"       , RS, ++i, TILDA__TESTING_Factory.COLS.A10C       , TILDA__TESTING_Factory.COLS.A10CTZ       ); if (RS.wasNull() == true) __Nulls.or(TILDA__TESTING_Factory.COLS.A10C._Mask       );
   ...
   public String toString()
    {
      ...
      String Str = 
               ...
               + "; a10c"          + (__Nulls.intersects(TILDA__TESTING_Factory.COLS.A10C._Mask) == true ? ": NULL" : ": " + DateTimeUtil.printDateTimeForJSON(getA10c       ()))
