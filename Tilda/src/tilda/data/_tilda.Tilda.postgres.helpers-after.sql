...
insert into TILDA.ZoneInfo ("id", "label", "value", "deactivatedTZ", "deactivated", "created", "lastUpdated")
   values ('UTC'  , 'UTC'                , 'Etc/UTC'            , null, null, current_timestamp, current_timestamp)
         ...
         ,('EUBer', 'Europe Berlin'      , 'Europe/Berlin'      , null, null, current_timestamp, current_timestamp)
         ,('EUAms', 'Europe Amsterdam'   , 'Europe/Amsterdam'   , null, null, current_timestamp, current_timestamp)
         ...
         ,('AmNYC', 'US New York City'   , 'America/New_York'   , null, null, current_timestamp, current_timestamp)
         ...
         ,('AmChi', 'US Chicago'         , 'America/Chicago'    , null, null, current_timestamp, current_timestamp)
         ...
         ,('AmDen', 'US Denver'          , 'America/Denver'    , null, null, current_timestamp, current_timestamp)
