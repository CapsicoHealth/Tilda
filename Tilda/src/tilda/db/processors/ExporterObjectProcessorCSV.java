...
public class ExporterObjectProcessorCSV<T extends CSVable> extends ExporterObjectProcessor<T>
  {
    ...
    public ExporterObjectProcessorCSV(Writer out, String outName, long logFreq, Class<?> factoryClass, boolean header)
      {
    ...
    public ExporterObjectProcessorCSV(String outFile, long logFreq, Class<?> factoryClass, boolean header)
