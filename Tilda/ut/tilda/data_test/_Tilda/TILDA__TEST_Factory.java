...
*/
     public final Type_StringPrimitive              ID         = new Type_StringPrimitive             (SCHEMA_LABEL, TABLENAME_LABEL, "id"         , 1/*1*/, 128, "The name of the test", null, null, null);
...
*/
     public final Type_StringPrimitive              NAME       = new Type_StringPrimitive             (SCHEMA_LABEL, TABLENAME_LABEL, "name"       , 2/*2*/, 128, "The name of the test", null, null, null);
          ...
          switch (LookupId)
           {
             ...
             case 2: // Query 'All'
                ...
                S.append(" order by "); C.getFullColumnVar(S, "TILDATEST", "Test", "name"); S.append(" ASC");
                break;
             case -77: 
             case -666: break;
...
*/
   static public tilda.data_test.Test_Data init(Map<String, String[]> Values, List<StringStringPair> Errors)
   throws Exception
     {
   ...
   public static int writeBatch(Connection C, List<tilda.data_test.Test_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_5.handleFinally(PS, T0, TILDA__TEST_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
...
*/   static public void lookupWhereAll(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Test_Data> OP, int start, int size) throws Exception
   ...
   public static void toJSON(java.io.Writer out, tilda.data_test.Test_Data obj, boolean fullObject) throws java.io.IOException
    {
