...
*/
     public final Type_StringPrimitiveNull          DESC6      = new Type_StringPrimitiveNull         (SCHEMA_LABEL, TABLENAME_LABEL, "desc6"      , 7/*7*/, 33000, "The title for a person, i.e., Mr, Miss, Mrs...", null, null, null);
...
*/
     public final Type_DatetimePrimitiveNull        LASTUPDATED= new Type_DatetimePrimitiveNull       (SCHEMA_LABEL, TABLENAME_LABEL, "lastUpdated", 13/*13*/, "<B>Always True</B>: Blah...", new String[] {"GREATEST(lastUpdated, xxxLastUpdated)"}, new String[] {"lastUpdated", "xxxLastUpdated"});
   }

   public static COLS_BASE COLS = new COLS_BASE();
   public static final ColumnDefinition[] COLUMNS = new ColumnDefinition[] { COLS.REFNUM,COLS.NAME,COLS.DESCRIPTION,COLS.DESC2,COLS.DESC3,COLS.DESC4,COLS.DESC5,COLS.DESC6,COLS.BASTILLE,COLS.TOTO,COLS.DESC2_CAT1,COLS.DESC2_CAT2,COLS.DESC2_CAT3,COLS.LASTUPDATED };
   ...
   static public tilda.data_test.Testing4Realized_Data create() throws Exception
     {
       ...
       // Default Nullables
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.REFNUM._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.NAME._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.DESCRIPTION._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.DESC2._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.DESC3._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.DESC4._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.DESC5._Mask);
       Obj.__Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.DESC6._Mask);
   ...
   public static int writeBatch(Connection C, List<tilda.data_test.Testing4Realized_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_5.handleFinally(PS, T0, TILDA__TESTING4REALIZED_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
...
*/
   static public ListResults<tilda.data_test.Testing4Realized_Data> lookupWhereLastUpdated(Connection C, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING4REALIZED Obj = new tilda.data_test.Testing4Realized_Data();
...
Lookup records by the index 'LastUpdated' over  .<BR>The results are ordered by: lastUpdated desc
*/
   static public void lookupWhereLastUpdated(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Testing4Realized_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING4REALIZED Obj = new tilda.data_test.Testing4Realized_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
*/   static public void lookupWhereAll(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Testing4Realized_Data> OP, int start, int size) throws Exception
   ...
   public static String getCSVHeader()
    {
      return "\"refnum\",\"name\",\"description\",\"desc2\",\"desc3\",\"desc4\",\"desc5\",\"desc6\",\"bastille\",\"toto\",\"desc2_Cat1\",\"desc2_Cat2\",\"desc2_Cat3\",\"lastUpdated\"";
    }
