   ...
   protected final void getUpsertQueryPart(Connection C, StringBuilder str) throws Exception
     {
       ...
       switch (__LookupId)
        {
          case 0:
                TILDA__TESTING4REALIZED_Factory.COLS.REFNUM.getShortColumnVarForSelect(C, str);
             break;
       ...
       boolean first = true;
       str.append("set ");
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.REFNUM._Mask     ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.REFNUM.getShortColumnVarForSelect(C, str)     ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.REFNUM.getShortColumnVarForSelect(C, str)     ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.NAME._Mask       ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.NAME.getShortColumnVarForSelect(C, str)       ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.NAME.getShortColumnVarForSelect(C, str)       ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESCRIPTION._Mask) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESCRIPTION.getShortColumnVarForSelect(C, str); str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESCRIPTION.getShortColumnVarForSelect(C, str); str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC2._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC2.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC2.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC3._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC3.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC3.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC4._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC4.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC4.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC5._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC5.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC5.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC6._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC6.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC6.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.BASTILLE._Mask   ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.BASTILLE.getShortColumnVarForSelect(C, str)   ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.BASTILLE.getShortColumnVarForSelect(C, str)   ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.TOTO._Mask       ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.TOTO.getShortColumnVarForSelect(C, str)       ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.TOTO.getShortColumnVarForSelect(C, str)       ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT1._Mask ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT1.getShortColumnVarForSelect(C, str) ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT1.getShortColumnVarForSelect(C, str) ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT2._Mask ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT2.getShortColumnVarForSelect(C, str) ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT2.getShortColumnVarForSelect(C, str) ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT3._Mask ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT3.getShortColumnVarForSelect(C, str) ; str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.DESC2_CAT3.getShortColumnVarForSelect(C, str) ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTING4REALIZED_Factory.COLS.LASTUPDATED._Mask) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTING4REALIZED_Factory.COLS.LASTUPDATED.getShortColumnVarForSelect(C, str); str.append("=EXCLUDED."); TILDA__TESTING4REALIZED_Factory.COLS.LASTUPDATED.getShortColumnVarForSelect(C, str); str.append("\n"); }
     }
   ...
   public String getCSVHeader(String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": return tilda.data_test.Testing4Realized_Factory.getCSVHeader();
