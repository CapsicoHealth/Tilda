...
<LI>Has the following index:<UL><LI>formRefnum, questionId asc
</LI>
</UL></LI>
</UL>
<B>Description</B>:<BLOCKQUOTE style="border-left: 1px solid #EEE;padding-left: 5px;">Test answers</BLOCKQUOTE>
<BR>
This Table contains the following columns:<BLOCKQUOTE>
 <TABLE id="TestAnswer_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid #BBB;">
...
public abstract class TILDA__TESTANSWER implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject, tilda.interfaces.JSONable, tilda.interfaces.CSVable
 {
   ...
   public void setQuestionId(String v) throws Exception
     {
       ...
       if (TextUtil.isNullOrEmpty(v) == true)
        throw new Exception("Cannot set tilda.tutorial.data.TILDATUTORIAL.TestAnswer.questionId to null or an empty value: it's not nullable and empty values are not allowed.");
       else if (v.length() > 60)
...
*/
   public final boolean isNullAnswerId()
...
*/
   public void copyTo(tilda.tutorial.data._Tilda.TILDA__TESTANSWER Dst) throws Exception
     {
       ...
       if (__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.ANSWERID._Mask) == true || _answerId   ==null)
        Dst.setNullAnswerId   ();
       else
       ...
       if (__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.DELETED._Mask) == true || _deleted    ==null)
        Dst.setNullDeleted    ();
       else
   ...
   public tilda.tutorial.data.TestAnswer_Data copy() throws Exception
     {
       tilda.tutorial.data.TestAnswer_Data dst = new tilda.tutorial.data.TestAnswer_Data();
       copyTo(dst);
       return dst;
     }
   ...
   protected final boolean write(Connection C, boolean upsert) throws Exception
     {
       ...
       try
          ...
          switch (__LookupId)
           {
             ...
             case 1: // Unique Index 'FormAnswer'
               PS.setLong      (++i, __Saved_formRefnum );
               PS.setString    (++i, __Saved_questionId );
               break;
        ...
        {
          tilda.tutorial.data._Tilda.TILDA__2_5.handleFinally(PS, T0, TILDA__TESTANSWER_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
   ...
   protected final void getUpsertQueryPart(Connection C, StringBuilder str) throws Exception
     {
       ...
       switch (__LookupId)
        {
          case 1:
                TILDA__TESTANSWER_Factory.COLS.FORMREFNUM.getShortColumnVarForSelect(C, str);
                str.append(", ");
                TILDA__TESTANSWER_Factory.COLS.QUESTIONID.getShortColumnVarForSelect(C, str);
             break;
       ...
       boolean first = true;
       str.append("set ");
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.FORMREFNUM._Mask ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.FORMREFNUM.getShortColumnVarForSelect(C, str) ; str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.FORMREFNUM.getShortColumnVarForSelect(C, str) ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.QUESTIONID._Mask ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.QUESTIONID.getShortColumnVarForSelect(C, str) ; str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.QUESTIONID.getShortColumnVarForSelect(C, str) ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.ANSWERID._Mask   ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.ANSWERID.getShortColumnVarForSelect(C, str)   ; str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.ANSWERID.getShortColumnVarForSelect(C, str)   ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.TIMEMILLIS._Mask ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.TIMEMILLIS.getShortColumnVarForSelect(C, str) ; str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.TIMEMILLIS.getShortColumnVarForSelect(C, str) ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.CORRECT._Mask    ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.CORRECT.getShortColumnVarForSelect(C, str)    ; str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.CORRECT.getShortColumnVarForSelect(C, str)    ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.LASTUPDATED._Mask) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.LASTUPDATED.getShortColumnVarForSelect(C, str); str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.LASTUPDATED.getShortColumnVarForSelect(C, str); str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.DELETED._Mask    ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTANSWER_Factory.COLS.DELETED.getShortColumnVarForSelect(C, str)    ; str.append("=EXCLUDED."); TILDA__TESTANSWER_Factory.COLS.DELETED.getShortColumnVarForSelect(C, str)    ; str.append("\n"); }
       str.append("returning "); TILDA__TESTANSWER_Factory.COLS.REFNUM.getShortColumnVarForSelect(C, str);
     }
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.REFNUM._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.REFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.FORMREFNUM._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.FORMREFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.QUESTIONID._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.QUESTIONID.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.ANSWERID._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.ANSWERID.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.TIMEMILLIS._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.TIMEMILLIS.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.CORRECT._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.CORRECT.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.CREATED._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.DELETED._Mask) == true) { TILDA__TESTANSWER_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.tutorial.data._Tilda.TILDA__2_5._COMMAQUESTION);
           }
   ...
   protected int populatePreparedStatement(Connection C, java.sql.PreparedStatement PS, List<java.sql.Array> AllocatedArrays) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.QUESTIONID._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.QUESTIONID._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _questionId);
        } 
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.ANSWERID._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.ANSWERID._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _answerId);
        } 
       ...
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.CORRECT._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTANSWER_Factory.COLS.CORRECT._Mask) == true) PS.setNull(++i, java.sql.Types.SMALLINT  ); else PS.setShort     (++i, _correct);
        } 
       if (__Changes.intersects(TILDA__TESTANSWER_Factory.COLS.CREATED._Mask) == true) 
        { 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      ...
      __Saved_refnum      = _refnum      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.REFNUM._Mask     ); _refnum = null; }
      __Saved_formRefnum  = _formRefnum  =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.FORMREFNUM._Mask ); _formRefnum = null; }
      __Saved_questionId  = _questionId  = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.QUESTIONID._Mask ); _questionId = null; }
                            _answerId    = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.ANSWERID._Mask   ); _answerId = null; }
                            _timeMillis  =                              RS.getInt       (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.TIMEMILLIS._Mask ); _timeMillis = null; }
                            _correct     =                              RS.getShort     (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.CORRECT._Mask    ); _correct = null; }
                                                    _created     = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), OCCLocalZone); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.CREATED._Mask    ); _created = null; }
                                                    _lastUpdated = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), OCCLocalZone); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.LASTUPDATED._Mask); _lastUpdated = null; }
                                                    _deleted     = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), OCCLocalZone); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTANSWER_Factory.COLS.DELETED._Mask    ); _deleted = null; }
   ...
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, boolean noNullArrays) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.tutorial.data.TestAnswer_Factory.toJSON(out, (tilda.tutorial.data.TestAnswer_Data) this, lead, fullObject, noNullArrays); break;
          default: throw new Exception("Unknown JSON exporter '"+exportName+"' for tilda.tutorial.data.TestAnswer_Factory");
        } 
    }
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown JSON sync exporter '"+exportName+"' for tilda.tutorial.data.TestAnswer_Factory");
    }
   public String getCSVHeader(String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": return tilda.tutorial.data.TestAnswer_Factory.getCSVHeader();
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.tutorial.data.TestAnswer_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.tutorial.data.TestAnswer_Factory.toCSV(out, (tilda.tutorial.data.TestAnswer_Data) this); break;
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.tutorial.data.TestAnswer_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown CSV sync exporter '"+exportName+"' for tilda.tutorial.data.TestAnswer_Factory");
    }
 }
