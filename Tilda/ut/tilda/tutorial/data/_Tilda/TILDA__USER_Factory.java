...
*/
     public final Type_StringPrimitive              ID         = new Type_StringPrimitive             (SCHEMA_LABEL, TABLENAME_LABEL, "id"         , 1/*1*/, 40, "The user's id", null, null, null);
...
*/
     public final Type_StringPrimitive              EMAIL      = new Type_StringPrimitive             (SCHEMA_LABEL, TABLENAME_LABEL, "email"      , 2/*2*/, 255, "The user's email", null, null, null);
...
*/
     public final Type_DatetimePrimitive            CREATED    = new Type_DatetimePrimitive           (SCHEMA_LABEL, TABLENAME_LABEL, "created"    , 3/*3*/, "The timestamp for when the record was created. (TILDATUTORIAL.User)", null, null);
...
*/
     public final Type_DatetimePrimitive            LASTUPDATED= new Type_DatetimePrimitive           (SCHEMA_LABEL, TABLENAME_LABEL, "lastUpdated", 4/*4*/, "The timestamp for when the record was last updated. (TILDATUTORIAL.User)", null, null);
...
*/
     public final Type_DatetimePrimitiveNull        DELETED    = new Type_DatetimePrimitiveNull       (SCHEMA_LABEL, TABLENAME_LABEL, "deleted"    , 5/*5*/, "The timestamp for when the record was deleted. (TILDATUTORIAL.User)", null, null);
   }

   public static COLS_BASE COLS = new COLS_BASE();
   public static final ColumnDefinition[] COLUMNS = new ColumnDefinition[] { COLS.REFNUM,COLS.ID,COLS.EMAIL,COLS.CREATED,COLS.LASTUPDATED,COLS.DELETED };
   ...
   public static int writeBatch(Connection C, List<tilda.tutorial.data.User_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_5.handleFinally(PS, T0, TILDA__USER_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
...
/**
Lookup one record by the unique index 'Email': email.
*/
...
*/
   static public ListResults<tilda.tutorial.data.User_Data> lookupWhereAll(Connection C, int __start__, int __size__) throws Exception
     {
       tilda.tutorial.data._Tilda.TILDA__USER Obj = new tilda.tutorial.data.User_Data();
...
Lookup records by the index 'All' over  .<BR>The results are ordered by: lastUpdated asc
*/
   static public void lookupWhereAll(Connection C, tilda.db.processors.ObjectProcessor<tilda.tutorial.data.User_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.tutorial.data._Tilda.TILDA__USER Obj = new tilda.tutorial.data.User_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
   ...
   public static String getCSVHeader()
    {
      return "\"refnum\",\"id\",\"email\",\"created\",\"lastUpdated\",\"deleted\"";
    }

   public static void toCSV(java.io.Writer out, List<tilda.tutorial.data.User_Data> L, boolean includeHeader) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (includeHeader == true)
        out.write(getCSVHeader() + "\n");
      for (tilda.tutorial.data.User_Data O : L)
       if (O!=null)
        {
          toCSV(out, O);
          out.write("\n");
   ...
   public static void toCSV(java.io.Writer out, tilda.tutorial.data.User_Data obj) throws java.io.IOException
    {
      long T0 = System.nanoTime();
     tilda.tutorial.data._Tilda.TILDA__USER Obj = (tilda.tutorial.data._Tilda.TILDA__USER) obj;
      ...
      Str.append(",");
      TextUtil.escapeDoubleQuoteForCSV(Str, Obj.getEmail());
      Str.append(",");
   ...
   public static void toJSON(java.io.Writer out, List<tilda.tutorial.data.User_Data> L, String lead, boolean fullList) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (fullList == true)
        {
   ...
   public static void toJSON(java.io.Writer out, tilda.tutorial.data.User_Data obj, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, "", fullObject, false);
    }

   public static void toJSON(java.io.Writer out, tilda.tutorial.data.User_Data obj, String lead, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, lead, fullObject, false);
    }

   public static void toJSON(java.io.Writer outWriter, tilda.tutorial.data.User_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      try(org.apache.commons.io.output.StringBuilderWriter out = new org.apache.commons.io.output.StringBuilderWriter())
       {
        ...
        JSONUtil.print(out, "email", ++i==0, Obj.getEmail());
