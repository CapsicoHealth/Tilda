...
<B>Description</B>:<BLOCKQUOTE style="border-left: 1px solid #EEE;padding-left: 5px;">Questions and answers for multiple-choice tests</BLOCKQUOTE>
<BR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.refnum</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.type</TD></TR>
...
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>questionSeq of type int</TD></TR>
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.questionSeq</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.questionId</TD></TR>
...
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>questionLabel of type String</TD></TR>
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.questionLabel</TD></TR>
...
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>answerSeq of type int</TD></TR>
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.answerSeq</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.answerId</TD></TR>
...
This is the definition for:<BR>
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  <TR><TD align="right"><B>Name</B></TD><TD>answerLabel of type String</TD></TR>
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.answerLabel</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.created</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.lastUpdated</TD></TR>
...
<TABLE border="0px" cellpadding="3px" cellspacing="0px">
  ...
  <TR><TD align="right"><B>Full Name</B></TD><TD>tilda.tutorial.data.TILDATUTORIAL.TestQuestionAnswer.deleted</TD></TR>
          ...
          switch (__LookupId)
           {
             ...
             case 1: // Unique Index 'FormAnswer'
               PS.setString    (++i, __Saved_type         );
               PS.setString    (++i, __Saved_questionId   );
               PS.setInt       (++i, __Saved_answerSeq    );
               break;
   ...
   protected final void getUpsertQueryPart(Connection C, StringBuilder str) throws Exception
     {
       ...
       switch (__LookupId)
        {
          case 1:
                TILDA__TESTQUESTIONANSWER_Factory.COLS.TYPE.getShortColumnVarForSelect(C, str);
                str.append(", ");
                TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONID.getShortColumnVarForSelect(C, str);
                str.append(", ");
                TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERSEQ.getShortColumnVarForSelect(C, str);
             break;
       ...
       boolean first = true;
       str.append("set ");
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.TYPE._Mask         ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.TYPE.getShortColumnVarForSelect(C, str)         ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.TYPE.getShortColumnVarForSelect(C, str)         ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONSEQ._Mask  ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONSEQ.getShortColumnVarForSelect(C, str)  ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONSEQ.getShortColumnVarForSelect(C, str)  ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONID._Mask   ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONID.getShortColumnVarForSelect(C, str)   ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONID.getShortColumnVarForSelect(C, str)   ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONLABEL._Mask) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONLABEL.getShortColumnVarForSelect(C, str); str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONLABEL.getShortColumnVarForSelect(C, str); str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERSEQ._Mask    ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERSEQ.getShortColumnVarForSelect(C, str)    ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERSEQ.getShortColumnVarForSelect(C, str)    ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERID._Mask     ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERID.getShortColumnVarForSelect(C, str)     ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERID.getShortColumnVarForSelect(C, str)     ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERLABEL._Mask  ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERLABEL.getShortColumnVarForSelect(C, str)  ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERLABEL.getShortColumnVarForSelect(C, str)  ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.CORRECT._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.CORRECT.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.CORRECT.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.LASTUPDATED._Mask  ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.LASTUPDATED.getShortColumnVarForSelect(C, str)  ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.LASTUPDATED.getShortColumnVarForSelect(C, str)  ; str.append("\n"); }
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.DELETED._Mask      ) == true) { if (first == true) first = false; else str.append("    ,"); TILDA__TESTQUESTIONANSWER_Factory.COLS.DELETED.getShortColumnVarForSelect(C, str)      ; str.append("=EXCLUDED."); TILDA__TESTQUESTIONANSWER_Factory.COLS.DELETED.getShortColumnVarForSelect(C, str)      ; str.append("\n"); }
       str.append("returning "); TILDA__TESTQUESTIONANSWER_Factory.COLS.REFNUM.getShortColumnVarForSelect(C, str);
     }
   ...
   protected int populatePreparedStatement(Connection C, java.sql.PreparedStatement PS, List<java.sql.Array> AllocatedArrays) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.TYPE._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.TYPE._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _type);
        } 
       ...
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONID._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONID._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _questionId);
        } 
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONLABEL._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.QUESTIONLABEL._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _questionLabel);
        } 
       ...
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERID._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERID._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _answerId);
        } 
       if (__Changes.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERLABEL._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERLABEL._Mask) == true) PS.setNull(++i, java.sql.Types.VARCHAR   ); else PS.setString    (++i, _answerLabel);
        } 
   ...
   private final boolean readOne(Connection C, boolean Force) throws Exception
     {
       ...
       StringBuilder S = new StringBuilder(1024);
          S.append("select ");
          C.getFullColumnVarList(S, TILDA__TESTQUESTIONANSWER_Factory.COLUMNS);
     ...
     __Init = InitMode.LOOKUP;
      ...
      __Saved_answerSeq     = _answerSeq     =                              RS.getInt       (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTQUESTIONANSWER_Factory.COLS.ANSWERSEQ._Mask    ); _answerSeq = null; }
                              ...
                              _correct       =                              RS.getShort     (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTQUESTIONANSWER_Factory.COLS.CORRECT._Mask      ); _correct = null; }
                                                        _created       = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), OCCLocalZone); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTQUESTIONANSWER_Factory.COLS.CREATED._Mask      ); _created = null; }
                                                        _lastUpdated   = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), OCCLocalZone); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTQUESTIONANSWER_Factory.COLS.LASTUPDATED._Mask  ); _lastUpdated = null; }
                                                        _deleted       = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i), OCCLocalZone); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTQUESTIONANSWER_Factory.COLS.DELETED._Mask      ); _deleted = null; }
   ...
   public String getCSVHeader(String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": return tilda.tutorial.data.TestQuestionAnswer_Factory.getCSVHeader();
