...
<B>Description</B>:<BLOCKQUOTE style="border-left: 1px solid #EEE;padding-left: 5px;">A pivoted view of XYZ forms</BLOCKQUOTE>
<BR>
...
This View contains the following columns:<BLOCKQUOTE>
 <TABLE id="Test_XYZ_PivotView_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid #BBB;">
...
public abstract class TILDA__TEST_XYZ_PIVOTVIEW implements tilda.interfaces.ReaderObject, tilda.interfaces.JSONable, tilda.interfaces.CSVable
 {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  throws Exception
   ...
   public String toString()
    {
      ...
      String Str = 
               ...
               + "; QX_correct: "                                                                                                          +                                   getQX_correct     ()
               + "; QX_timeMillis: "                                                                                                       +                                   getQX_timeMillis  ()
               + "; QY_correct: "                                                                                                          +                                   getQY_correct     ()
               + "; QY_timeMillis: "                                                                                                       +                                   getQY_timeMillis  ()
               + "; QZ_correct: "                                                                                                          +                                   getQZ_correct     ()
               + "; QZ_timeMillis: "                                                                                                       +                                   getQZ_timeMillis  ()
         + ";";
   ...
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, boolean noNullArrays) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.tutorial.data.Test_XYZ_PivotView_Factory.toJSON(out, (tilda.tutorial.data.Test_XYZ_PivotView_Data) this, lead, fullObject, noNullArrays); break;
          default: throw new Exception("Unknown JSON exporter '"+exportName+"' for tilda.tutorial.data.Test_XYZ_PivotView_Factory");
        } 
    }
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown JSON sync exporter '"+exportName+"' for tilda.tutorial.data.Test_XYZ_PivotView_Factory");
    }
   public void toCSV(java.io.Writer out, String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.tutorial.data.Test_XYZ_PivotView_Factory.toCSV(out, (tilda.tutorial.data.Test_XYZ_PivotView_Data) this); break;
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.tutorial.data.Test_XYZ_PivotView_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown CSV sync exporter '"+exportName+"' for tilda.tutorial.data.Test_XYZ_PivotView_Factory");
    }
 }
