   ...
   public static void initSchema(Connection C) throws Exception
    {
      ...
      tilda.tutorial.data._Tilda.TILDA__TEST_XYZ_PIVOTVIEW_Factory.initObject(C);
      tilda.tutorial.data._Tilda.TILDA__TEST_XYZ_REALIZED_Factory.initObject(C);
      tilda.tutorial.data._Tilda.TILDA__TEST_VIEW_Factory.initObject(C);
      tilda.tutorial.data._Tilda.TILDA__TEST_REALIZED_Factory.initObject(C);
      tilda.tutorial.data._Tilda.TILDA__TEST_XYZ_ANALYTICS_VIEW_Factory.initObject(C);
      tilda.tutorial.data._Tilda.TILDA__TEST_XYZ_ANALYTICS_REALIZED_Factory.initObject(C);
    }
