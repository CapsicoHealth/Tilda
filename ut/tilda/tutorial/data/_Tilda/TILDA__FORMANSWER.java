   ...
   public final boolean write(Connection C) throws Exception
     {
       ...
       try
        ...
        {
          tilda.tutorial.data._Tilda.TILDA__1_0.handleFinally(PS, T0, TILDA__FORMANSWER_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.REFNUM._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.REFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.FORMREFNUM._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.FORMREFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.FIELD._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.FIELD.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.VALUE._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.VALUE.getFullColumnVarForInsert(C, S); V.append(tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.CREATED._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORMANSWER_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORMANSWER_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FORMANSWER_Factory.COLS.DELETED._Mask) == true) { TILDA__FORMANSWER_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORMANSWER_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.tutorial.data._Tilda.TILDA__1_0._COMMAQUESTION);
           }
