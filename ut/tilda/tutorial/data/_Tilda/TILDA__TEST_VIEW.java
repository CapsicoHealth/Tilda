...
<TR ><TD>1</TD><TD>testFirstTZ</TD><TD><A href="TILDA___Docs.TILDA.html#ZoneInfo_CNT">TILDA<B>&nbsp;&#8226;&nbsp;</B>ZoneInfo</A></TD><TD>id</TD><TD>&nbsp;</TD></TR>
</TABLE></LI>
</UL>
...
This View contains the following columns:<BLOCKQUOTE>
 <TABLE id="Test_View_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid #BBB;">
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Form template type<DIV style="margin:0px;margin-left:20px;font-size:75%;">&rarr;&nbsp;<A href="javascript:openDiv('Form-type_DIV', -50)">TILDATUTORIAL<B>&nbsp;&#8226;&nbsp;</B>Form<B>&nbsp;&#8226;&nbsp;</B>type</A></DIV></TD>
</TR>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Generated helper column to hold the time zone ID for 'testFirst'.<DIV style="margin:0px;margin-left:20px;font-size:75%;">&rarr;&nbsp;<A href="javascript:openDiv('Form-fillDateTZ_DIV', -50)">TILDATUTORIAL<B>&nbsp;&#8226;&nbsp;</B>Form<B>&nbsp;&#8226;&nbsp;</B>fillDateTZ</A><BR>&rarr;&nbsp;<A href="TILDA___Docs.TILDA.html#ZoneInfo-id_DIV">TILDA<B>&nbsp;&#8226;&nbsp;</B>ZoneInfo<B>&nbsp;&#8226;&nbsp;</B>id</A></DIV></TD>
</TR>
  <TR valign="top" style="background-color:#FFFFFF;">
    <TD>4&nbsp;&nbsp;</TD>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Generated helper column to hold the time zone ID for 'testLast'.<DIV style="margin:0px;margin-left:20px;font-size:75%;">&rarr;&nbsp;<A href="javascript:openDiv('Form-fillDateTZ_DIV', -50)">TILDATUTORIAL<B>&nbsp;&#8226;&nbsp;</B>Form<B>&nbsp;&#8226;&nbsp;</B>fillDateTZ</A><BR>&rarr;&nbsp;<A href="TILDA___Docs.TILDA.html#ZoneInfo-id_DIV">TILDA<B>&nbsp;&#8226;&nbsp;</B>ZoneInfo<B>&nbsp;&#8226;&nbsp;</B>id</A></DIV></TD>
</TR>
  <TR valign="top" style="background-color:#FFFFFF;">
    <TD>6&nbsp;&nbsp;</TD>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Whether the answer is correct or not<DIV style="margin:0px;margin-left:20px;font-size:75%;">&rarr;&nbsp;<A href="javascript:openDiv('TestAnswer-correct_DIV', -50)">TILDATUTORIAL<B>&nbsp;&#8226;&nbsp;</B>TestAnswer<B>&nbsp;&#8226;&nbsp;</B>correct</A></DIV></TD>
</TR>
  <TR valign="top" style="background-color:rgba(160, 199, 234, 0.2);">
    <TD>9&nbsp;&nbsp;</TD>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>Time in milliseconds for the time spent answering the question<DIV style="margin:0px;margin-left:20px;font-size:75%;">&rarr;&nbsp;<A href="javascript:openDiv('TestAnswer-timeMillis_DIV', -50)">TILDATUTORIAL<B>&nbsp;&#8226;&nbsp;</B>TestAnswer<B>&nbsp;&#8226;&nbsp;</B>timeMillis</A></DIV></TD>
</TR>
  <TR valign="top" style="background-color:#FFFFFF;">
    <TD>12&nbsp;&nbsp;</TD>
...
public abstract class TILDA__TEST_VIEW implements tilda.interfaces.ReaderObject, tilda.interfaces.JSONable, tilda.interfaces.CSVable
 {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
      int i = 0;
     __Init = InitMode.LOOKUP;
                                     _type                 = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TYPE._Mask                ); _type = null; }
                                     _testCount            =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TESTCOUNT._Mask           ); _testCount = null; }
                                     _testFirstTZ          = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TESTFIRSTTZ._Mask         ); _testFirstTZ = null; }
                                     _testFirst            = processZDT(_testFirstTZ           , "tilda.tutorial.data.TILDATUTORIAL.Test_View.testFirst"           , RS, ++i, TILDA__TEST_VIEW_Factory.COLS.TESTFIRST           , TILDA__TEST_VIEW_Factory.COLS.TESTFIRSTTZ           ); if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TESTFIRST._Mask           ); _testFirst = null; }
                                     _testLastTZ           = TextUtil.trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TESTLASTTZ._Mask          ); _testLastTZ = null; }
                                     _testLast             = processZDT(_testLastTZ            , "tilda.tutorial.data.TILDATUTORIAL.Test_View.testLast"            , RS, ++i, TILDA__TEST_VIEW_Factory.COLS.TESTLAST            , TILDA__TEST_VIEW_Factory.COLS.TESTLASTTZ            ); if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TESTLAST._Mask            ); _testLast = null; }
                                     _userCount            =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.USERCOUNT._Mask           ); _userCount = null; }
                                     _answerCount          =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.ANSWERCOUNT._Mask         ); _answerCount = null; }
                                     _answerCountCorrect   =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.ANSWERCOUNTCORRECT._Mask  ); _answerCountCorrect = null; }
                                     _answerCountIncorrect =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.ANSWERCOUNTINCORRECT._Mask); _answerCountIncorrect = null; }
                                     _timeMillisTotal      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TIMEMILLISTOTAL._Mask     ); _timeMillisTotal = null; }
                                     _timeMillisAvg        =                              RS.getDouble    (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TIMEMILLISAVG._Mask       ); _timeMillisAvg = null; }
                                     _timeMillisMin        =                              RS.getInt       (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TIMEMILLISMIN._Mask       ); _timeMillisMin = null; }
                                     _timeMillisMax        =                              RS.getInt       (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TEST_VIEW_Factory.COLS.TIMEMILLISMAX._Mask       ); _timeMillisMax = null; }
     __LookupId = 0;
  ...
  throws Exception
   ...
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, boolean noNullArrays) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.tutorial.data.Test_View_Factory.toJSON(out, (tilda.tutorial.data.Test_View_Data) this, lead, fullObject, noNullArrays); break;
          default: throw new Exception("Unknown JSON exporter '"+exportName+"' for tilda.tutorial.data.Test_View_Factory");
        } 
    }
   public void toJSON(java.io.Writer out, String exportName, String lead, boolean fullObject, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown JSON sync exporter '"+exportName+"' for tilda.tutorial.data.Test_View_Factory");
    }
   public void toCSV(java.io.Writer out, String exportName) throws Exception
    {
      switch (exportName)
        { 
          case "": tilda.tutorial.data.Test_View_Factory.toCSV(out, (tilda.tutorial.data.Test_View_Data) this); break;
          default: throw new Exception("Unknown CSV exporter '"+exportName+"' for tilda.tutorial.data.Test_View_Factory");
        } 
    }
   public void toCSV(java.io.Writer out, String exportName, java.time.ZonedDateTime lastsync) throws Exception
    {
      throw new Exception("Unknown CSV sync exporter '"+exportName+"' for tilda.tutorial.data.Test_View_Factory");
    }
 }
