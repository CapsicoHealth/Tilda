   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      __Saved_refnum      = _refnum      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.REFNUM._Mask     ); _refnum = null; }
                            ...
                            _a3b = (List<Boolean>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A3B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A3B._Mask        ); _a3b = null; }
                            _a4          =                              RS.getDouble    (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A4._Mask         ); _a4 = null; }
                            _a4b = (List<Double>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A4B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A4B._Mask        ); _a4b = null; }
                            _a5          =                              RS.getFloat     (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A5._Mask         ); _a5 = null; }
                            _a5b = (List<Float>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A5B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A5B._Mask        ); _a5b = null; }
                            _a7          =                              RS.getInt       (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A7._Mask         ); _a7 = null; }
                            _a7b = (List<Integer>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A7B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A7B._Mask        ); _a7b = null; }
                            ...
                            _a11b = (List<BigDecimal>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A11B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A11B._Mask       ); _a11b = null; }
                            ...
                            _a12b = (List<Short>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A12B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A12B._Mask       ); _a12b = null; }
                            ...
                            _a13b = (List<UUID>) C.getArray(RS, ++i, TILDA__TESTING4REALIZED_Factory.COLS.A13B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING4REALIZED_Factory.COLS.A13B._Mask       ); _a13b = null; }
