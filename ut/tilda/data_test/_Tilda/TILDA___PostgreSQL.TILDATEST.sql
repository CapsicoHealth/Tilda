...
create table if not exists TILDATEST.Testing2Realized -- Realized table for view TILDATEST.Testing2View: A test view to test .* and exclude and block.
 (  "refnum"          bigint                         -- The primary key for this record (from TILDATEST.Testing2View.refnum)
  ...
  , "a3"              boolean                        -- <B>Not A3</B>: Blah... (from TILDATEST.Testing2View.a3)
  , "bastille"        timestamptz                    -- <B>Bastille Day</B>: Blah... (from TILDATEST.Testing2View.bastille)
  , "toto"            timestamptz                    -- <B>Last Updated</B>: Blah... (from TILDATEST.Testing2View.toto)
  , "desc2_Cat1"      double precision               -- <B>desc2_Cat1 Title</B>: This formula checks whether the column 'desc2' contains the values 'a', 'b', 'c' for the View TILDATEST.Testing2View. (from TILDATEST.Testing2View.desc2_Cat1)
  , "desc2_Cat2"      double precision               -- <B>desc2_Cat2 Title</B>: This formula checks whether the column 'desc2' contains the values 'x', 'y', 'z' for the View TILDATEST.Testing2View. (from TILDATEST.Testing2View.desc2_Cat2)
  , "desc2_Cat3"      double precision               -- <B>desc2_Cat3 Title</B>: This formula checks whether the column 'desc2' contains the values 'x', 'y', 'z' for the View TILDATEST.Testing2View. (from TILDATEST.Testing2View.desc2_Cat3)
  , "a7_Cat4"         double precision               -- <B>a7_Cat4 Title</B>: This formula checks whether the column 'a7' value falls in the range of 0.0 and 10.0. (from TILDATEST.Testing2View.a7_Cat4)
  , "a7_Cat5"         double precision               -- <B>a7_Cat5 Title</B>: This formula checks whether the column 'a7' value falls in the range of 10.0 and 20.0. (from TILDATEST.Testing2View.a7_Cat5)
  , "a5_null"         integer                        -- <B>Null a5</B>: Whether a5 is null or not (from TILDATEST.Testing2View.a5_null)
  , "a6_null"         integer                        -- <B>Null a6</B>: Whether a6 is null or not (from TILDATEST.Testing2View.a6_null)
  , "a7_null"         integer                        -- <B>Null a7</B>: Whether a7 is null or not (from TILDATEST.Testing2View.a7_null)
  , "a8_null"         integer                        -- <B>Null a8</B>: Whether a8 is null or not (from TILDATEST.Testing2View.a8_null)
 );
...
COMMENT ON COLUMN TILDATEST.Testing2Realized."a3" IS E'<B>Not A3</B>: Blah... (from TILDATEST.Testing2View.a3)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."bastille" IS E'<B>Bastille Day</B>: Blah... (from TILDATEST.Testing2View.bastille)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."toto" IS E'<B>Last Updated</B>: Blah... (from TILDATEST.Testing2View.toto)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."desc2_Cat1" IS E'<B>desc2_Cat1 Title</B>: This formula checks whether the column ''desc2'' contains the values ''a'', ''b'', ''c'' for the View TILDATEST.Testing2View. (from TILDATEST.Testing2View.desc2_Cat1)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."desc2_Cat2" IS E'<B>desc2_Cat2 Title</B>: This formula checks whether the column ''desc2'' contains the values ''x'', ''y'', ''z'' for the View TILDATEST.Testing2View. (from TILDATEST.Testing2View.desc2_Cat2)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."desc2_Cat3" IS E'<B>desc2_Cat3 Title</B>: This formula checks whether the column ''desc2'' contains the values ''x'', ''y'', ''z'' for the View TILDATEST.Testing2View. (from TILDATEST.Testing2View.desc2_Cat3)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."a7_Cat4" IS E'<B>a7_Cat4 Title</B>: This formula checks whether the column ''a7'' value falls in the range of 0.0 and 10.0. (from TILDATEST.Testing2View.a7_Cat4)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."a7_Cat5" IS E'<B>a7_Cat5 Title</B>: This formula checks whether the column ''a7'' value falls in the range of 10.0 and 20.0. (from TILDATEST.Testing2View.a7_Cat5)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."a5_null" IS E'<B>Null a5</B>: Whether a5 is null or not (from TILDATEST.Testing2View.a5_null)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."a6_null" IS E'<B>Null a6</B>: Whether a6 is null or not (from TILDATEST.Testing2View.a6_null)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."a7_null" IS E'<B>Null a7</B>: Whether a7 is null or not (from TILDATEST.Testing2View.a7_null)';
COMMENT ON COLUMN TILDATEST.Testing2Realized."a8_null" IS E'<B>Null a8</B>: Whether a8 is null or not (from TILDATEST.Testing2View.a8_null)';
...
create table if not exists TILDATEST.Testing4Realized -- Realized table for view TILDATEST.Testing4View: A test view to test .* and exclude and block.
 (  "refnum"       bigint                         -- The primary key for this record (from TILDATEST.Testing4View.refnum)
  ...
  , "bastille"     timestamptz                    -- <B>Bastille Day</B>: Blah... (from TILDATEST.Testing4View.bastille)
  , "toto"         timestamptz                    -- <B>Last Updated</B>: Blah... (from TILDATEST.Testing4View.toto)
  , "desc2_Cat1"   double precision               -- <B>desc2_Cat1 Title</B>: This formula checks whether the column 'desc2' contains the values 'a', 'b', 'c' for the View TILDATEST.Testing2View. (from TILDATEST.Testing4View.desc2_Cat1)
  , "desc2_Cat2"   double precision               -- <B>desc2_Cat2 Title</B>: This formula checks whether the column 'desc2' contains the values 'x', 'y', 'z' for the View TILDATEST.Testing2View. (from TILDATEST.Testing4View.desc2_Cat2)
  , "desc2_Cat3"   double precision               -- <B>desc2_Cat3 Title</B>: This formula checks whether the column 'desc2' contains the values 'x', 'y', 'z' for the View TILDATEST.Testing2View. (from TILDATEST.Testing4View.desc2_Cat3)
  , "a7_Cat4"      double precision               -- <B>a7_Cat4 Title</B>: This formula checks whether the column 'a7' value falls in the range of 0.0 and 10.0. (from TILDATEST.Testing4View.a7_Cat4)
  , "a7_Cat5"      double precision               -- <B>a7_Cat5 Title</B>: This formula checks whether the column 'a7' value falls in the range of 10.0 and 20.0. (from TILDATEST.Testing4View.a7_Cat5)
  , "a5_null"      integer                        -- <B>Null a5</B>: Whether a5 is null or not (from TILDATEST.Testing4View.a5_null)
  , "a6_null"      integer                        -- <B>Null a6</B>: Whether a6 is null or not (from TILDATEST.Testing4View.a6_null)
  , "a7_null"      integer                        -- <B>Null a7</B>: Whether a7 is null or not (from TILDATEST.Testing4View.a7_null)
  , "a8_null"      integer                        -- <B>Null a8</B>: Whether a8 is null or not (from TILDATEST.Testing4View.a8_null)
  , "a3"           boolean                        -- <B>Always True</B>: Blah... (from TILDATEST.Testing4View.a3)
  , "lastUpdated"  timestamptz                    -- <B>Always True</B>: Blah... (from TILDATEST.Testing4View.lastUpdated)
 );
...
COMMENT ON COLUMN TILDATEST.Testing4Realized."bastille" IS E'<B>Bastille Day</B>: Blah... (from TILDATEST.Testing4View.bastille)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."toto" IS E'<B>Last Updated</B>: Blah... (from TILDATEST.Testing4View.toto)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."desc2_Cat1" IS E'<B>desc2_Cat1 Title</B>: This formula checks whether the column ''desc2'' contains the values ''a'', ''b'', ''c'' for the View TILDATEST.Testing2View. (from TILDATEST.Testing4View.desc2_Cat1)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."desc2_Cat2" IS E'<B>desc2_Cat2 Title</B>: This formula checks whether the column ''desc2'' contains the values ''x'', ''y'', ''z'' for the View TILDATEST.Testing2View. (from TILDATEST.Testing4View.desc2_Cat2)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."desc2_Cat3" IS E'<B>desc2_Cat3 Title</B>: This formula checks whether the column ''desc2'' contains the values ''x'', ''y'', ''z'' for the View TILDATEST.Testing2View. (from TILDATEST.Testing4View.desc2_Cat3)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a7_Cat4" IS E'<B>a7_Cat4 Title</B>: This formula checks whether the column ''a7'' value falls in the range of 0.0 and 10.0. (from TILDATEST.Testing4View.a7_Cat4)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a7_Cat5" IS E'<B>a7_Cat5 Title</B>: This formula checks whether the column ''a7'' value falls in the range of 10.0 and 20.0. (from TILDATEST.Testing4View.a7_Cat5)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a5_null" IS E'<B>Null a5</B>: Whether a5 is null or not (from TILDATEST.Testing4View.a5_null)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a6_null" IS E'<B>Null a6</B>: Whether a6 is null or not (from TILDATEST.Testing4View.a6_null)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a7_null" IS E'<B>Null a7</B>: Whether a7 is null or not (from TILDATEST.Testing4View.a7_null)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a8_null" IS E'<B>Null a8</B>: Whether a8 is null or not (from TILDATEST.Testing4View.a8_null)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."a3" IS E'<B>Always True</B>: Blah... (from TILDATEST.Testing4View.a3)';
COMMENT ON COLUMN TILDATEST.Testing4Realized."lastUpdated" IS E'<B>Always True</B>: Blah... (from TILDATEST.Testing4View.lastUpdated)';
...
select TILDATEST.Testing2View."refnum" as "refnum" -- The primary key for this record
     ...
     , TILDATEST.Testing2View."a8_null" as "a8_null" -- <B>Null a8</B>: Whether a8 is null or not
  from TILDATEST.Testing2View
...
select TILDATEST.Testing2Realized."refnum" as "refnum" -- The primary key for this record
     ...
     , TILDATEST.Testing2Realized."a8_null" as "a8_null" -- <B>Null a8</B>: Whether a8 is null or not
  from TILDATEST.Testing2Realized
...
COMMENT ON COLUMN TILDATEST.Testing4View."a8_null" IS E'<B>Null a8</B>: Whether a8 is null or not';
