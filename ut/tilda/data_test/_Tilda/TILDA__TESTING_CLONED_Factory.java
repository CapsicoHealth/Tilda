   ...
   static public tilda.data_test.Testing_Cloned_Data create(List<Long> refnum2, String name) throws Exception
     {
       ...
       // Default Nullables
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.DESCRIPTION._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.DESC2._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.DESC3._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.DESC4._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.DESC5._Mask);
       ...
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A3._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A3B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A4._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A4B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A5._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A5B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6C._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6D._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A7._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A7B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A8B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A9B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A9C._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A9D._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A10A._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A10B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A10C._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A11._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A11B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A11C._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A12._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A12B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A13._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A13B._Mask);
       Obj.__Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A14._Mask);
   ...
   public static int writeBatch(Connection C, List<tilda.data_test.Testing_Cloned_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_5.handleFinally(PS, T0, TILDA__TESTING_CLONED_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
           AllocatedArrays = null;
         }
       }
...
*/
   static public ListResults<tilda.data_test.Testing_Cloned_Data> lookupWhereAllByName(Connection C, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
...
Lookup records by the index 'AllByName' over  .<BR>The results are ordered by: name asc
*/
   static public void lookupWhereAllByName(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Testing_Cloned_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
*/
   static public ListResults<tilda.data_test.Testing_Cloned_Data> lookupWhereAllByName2(Connection C, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
Lookup records by the index 'AllByName2' over  .<BR>The results are ordered by: name asc
*/
   static public void lookupWhereAllByName2(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Testing_Cloned_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
*/
   static public ListResults<tilda.data_test.Testing_Cloned_Data> lookupWhereAllByName3(Connection C, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
Lookup records by the index 'AllByName3' over  .<BR>The results are ordered by: name desc
*/
   static public void lookupWhereAllByName3(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Testing_Cloned_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
*/
   static public ListResults<tilda.data_test.Testing_Cloned_Data> lookupWhereAllByName4(Connection C, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
Lookup records by the index 'AllByName4' over  .<BR>The results are ordered by: name asc, description desc
*/
   static public void lookupWhereAllByName4(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.Testing_Cloned_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = new tilda.data_test.Testing_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
