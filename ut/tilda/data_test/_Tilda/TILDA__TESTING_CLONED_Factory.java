...
*/
     public static Type_DatetimePrimitive      CREATED    = new Type_DatetimePrimitive     (SCHEMA_LABEL, TABLENAME_LABEL, "created"    , 49/*49*/, "The timestamp for when the record was created. (TILDATEST.Testing_Cloned)");
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
     public static Type_DatetimePrimitive      LASTUPDATED= new Type_DatetimePrimitive     (SCHEMA_LABEL, TABLENAME_LABEL, "lastUpdated", 50/*50*/, "The timestamp for when the record was last updated. (TILDATEST.Testing_Cloned)");
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/
     public static Type_DatetimePrimitiveNull  DELETED    = new Type_DatetimePrimitiveNull (SCHEMA_LABEL, TABLENAME_LABEL, "deleted"    , 51/*51*/, "The timestamp for when the record was deleted. (TILDATEST.Testing_Cloned)");
;
   }
          ...
          switch (LookupId)
           {
             ...
             case 3:
                ...
                break;
             case 4:
                S.append(" where ("); C.getFullColumnVar(S, "TILDATEST", "Testing_Cloned", "deleted"); S.append(" is null and "); C.getFullColumnVar(S, "TILDATEST", "Testing_Cloned", "name"); S.append(" = 'Hello' and "); C.getFullColumnVar(S, "TILDATEST", "Testing_Cloned", "created"); S.append(" > '2018-01-01')");
...
*/
   ...
   public static void toJSONCCC(java.io.Writer out, tilda.data_test.Testing_Cloned_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
   ...
   public static void toJSONAAA(java.io.Writer out, tilda.data_test.Testing_Cloned_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      tilda.data_test._Tilda.TILDA__TESTING_CLONED Obj = (tilda.data_test._Tilda.TILDA__TESTING_CLONED) obj;
      if (fullObject == true)
