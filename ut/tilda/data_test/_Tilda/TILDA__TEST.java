...
This Table contains the following columns:<BLOCKQUOTE>
 <TABLE id="Test_TBL" border="0px" cellpadding="3px" cellspacing="0px" style="border:1px solid grey;">
...
public abstract class TILDA__TEST implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject, tilda.interfaces.JSONable
 {
   protected static final Logger LOG = LogManager.getLogger(TILDA__TEST.class.getName());

   public static final Class<TILDA__TEST_Factory> FACTORY_CLASS= TILDA__TEST_Factory.class;
   public static final String TABLENAME = TextUtil.Print("TILDATEST.Test", "");
   ...
   protected void setId(String v) throws Exception
     {
       ...
       if (v == null)
        ...
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Test.id: the value "+TextUtil.escapeDoubleQuoteWithSlash(v)+" is larger than the max size allowed 128.");
   ...
   protected void setName(String v) throws Exception
     {
       ...
       if (v == null)
        ...
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Test.name: the value "+TextUtil.escapeDoubleQuoteWithSlash(v)+" is larger than the max size allowed 128.");
   ...
   public void CopyTo(tilda.data_test._Tilda.TILDA__TEST Dst) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TEST_Factory.COLS.DELETED._Mask) == true) Dst.setNullDeleted    (); else        Dst.setDeleted    (_deleted    );
     }
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.REFNUM._Mask) == true) { TILDA__TEST_Factory.COLS.REFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.ID._Mask) == true) { TILDA__TEST_Factory.COLS.ID.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.NAME._Mask) == true) { TILDA__TEST_Factory.COLS.NAME.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.TEST_FK._Mask) == true) { TILDA__TEST_Factory.COLS.TEST_FK.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.CREATED._Mask) == true) { TILDA__TEST_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TEST_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__TEST_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TEST_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__TEST_Factory.COLS.DELETED._Mask) == true) { TILDA__TEST_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TEST_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
       ...
       else // InitMode can be anything else
        {
          ...
          switch (__LookupId)
           {
             case 0:
                S.append(" where ("); C.getFullColumnVar(S, "TILDATEST", "Test", "refnum"); S.append("=?)");
                break;
             case 1:
                S.append(" where ("); C.getFullColumnVar(S, "TILDATEST", "Test", "name"); S.append("=?)");
                break;
             case -77: 
   ...
   protected int populatePreparedStatement(Connection C, java.sql.PreparedStatement PS, List<java.sql.Array> AllocatedArrays) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__TEST_Factory.COLS.ID._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TEST_Factory.COLS.ID._Mask) == true) PS.setNull(++i, java.sql.Types.CHAR      ); else PS.setString    (++i, _id);
        } 
       if (__Changes.intersects(TILDA__TEST_Factory.COLS.NAME._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TEST_Factory.COLS.NAME._Mask) == true) PS.setNull(++i, java.sql.Types.CHAR      ); else PS.setString    (++i, _name);
        } 
       ...
       if (__Changes.intersects(TILDA__TEST_Factory.COLS.CREATED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TEST_Factory.COLS.CREATED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_created) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_created.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__TEST_Factory.COLS.LASTUPDATED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TEST_Factory.COLS.LASTUPDATED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_lastUpdated) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_lastUpdated.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__TEST_Factory.COLS.DELETED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__TEST_Factory.COLS.DELETED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_deleted) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_deleted.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       return i;
     }
   ...
   public final boolean Write(Connection C) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data_test._Tilda.TILDA__1_0.HandleFinally(PS, T0, TILDA__TEST_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
   ...
   boolean Init(Connection C, java.sql.ResultSet RS) throws Exception
    {
      int i = 0;
     __Init = InitMode.LOOKUP;
      __Saved_refnum      = _refnum      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.REFNUM._Mask     );
                            _id          = TextUtil.Trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.ID._Mask         );
      __Saved_name        = _name        = TextUtil.Trim               (RS.getString    (++i)) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.NAME._Mask       );
                            _test_fk     =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.TEST_FK._Mask    );
                            _created     = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.CREATED._Mask    );
                            _lastUpdated = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.LASTUPDATED._Mask);
                            _deleted     = DateTimeUtil.toZonedDateTime(RS.getTimestamp(++i, DateTimeUtil._UTC_CALENDAR), null); if (RS.wasNull() == true) __Nulls.or(TILDA__TEST_Factory.COLS.DELETED._Mask    );
     __LookupId = 0;
   ...
   public void toJSON(java.io.Writer Out, String ExportName, boolean FullObject) throws Exception
    {
      switch (ExportName)
        { 
          case "": tilda.data_test.Test_Json.toJSON(Out, (tilda.data_test.Test_Data) this, FullObject); break;
          default: throw new Exception("Unknown JSON exporter '"+ExportName+"' for tilda.data_test.Test_Json");
        } 
    }
 }
