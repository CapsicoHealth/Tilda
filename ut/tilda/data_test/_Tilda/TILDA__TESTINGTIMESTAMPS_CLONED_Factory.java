...
public class TILDA__TESTINGTIMESTAMPS_CLONED_Factory
 {
   protected static final Logger LOG = LogManager.getLogger(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.class.getName());

   protected TILDA__TESTINGTIMESTAMPS_CLONED_Factory() { }

   public static final Class<TILDA__TESTINGTIMESTAMPS_CLONED> DATA_CLASS= TILDA__TESTINGTIMESTAMPS_CLONED.class;
   public static final String SCHEMA_LABEL = TextUtil.print("TILDATEST", "");
   public static final String TABLENAME_LABEL = TextUtil.print("TestingTimestamps_Cloned", "");
   public static final String SCHEMA_TABLENAME_LABEL = TextUtil.print("TILDATEST.TestingTimestamps_Cloned", "");
   public static void getFullTableNameVar(Connection C, StringBuilder S) { C.getFullTableVar(S, "TILDATEST", "TestingTimestamps_Cloned"); }
...
*/
     public final Type_StringPrimitiveNull          ROWTZ_TILDATEST_TESTINGTIMESTAMPS_CLONED= new Type_StringPrimitiveNull         (SCHEMA_LABEL, TABLENAME_LABEL, "rowTZ_TILDATEST_TestingTimestamps_Cloned", 10/*10*/, 5, "Generated helper column to hold the time zone ID for 1 or more columns at the TILDATEST.TestingTimestamps_Cloned row level: dt2, dt2n, dt2u, dt2a, dt4, dt4n, dt4u, dt4a.", null, null, null);
...
*/
     public final Type_DatetimePrimitive            CREATED                                 = new Type_DatetimePrimitive           (SCHEMA_LABEL, TABLENAME_LABEL, "created"                                 , 27/*27*/, "The timestamp for when the record was created. (TILDATEST.TestingTimestamps_Cloned)", null, null);
...
*/
     public final Type_DatetimePrimitive            LASTUPDATED                             = new Type_DatetimePrimitive           (SCHEMA_LABEL, TABLENAME_LABEL, "lastUpdated"                             , 28/*28*/, "The timestamp for when the record was last updated. (TILDATEST.TestingTimestamps_Cloned)", null, null);
...
*/
     public final Type_DatetimePrimitiveNull        DELETED                                 = new Type_DatetimePrimitiveNull       (SCHEMA_LABEL, TABLENAME_LABEL, "deleted"                                 , 29/*29*/, "The timestamp for when the record was deleted. (TILDATEST.TestingTimestamps_Cloned)", null, null);
   }

   public static COLS_BASE COLS = new COLS_BASE();
   public static final ColumnDefinition[] COLUMNS = new ColumnDefinition[] { COLS.REFNUM,COLS.ID,COLS.DT1TZ,COLS.DT1,COLS.DT1NTZ,COLS.DT1N,COLS.DT1UTZ,COLS.DT1U,COLS.DT1ATZ,COLS.DT1A,COLS.ROWTZ_TILDATEST_TESTINGTIMESTAMPS_CLONED,COLS.DT2,COLS.DT2N,COLS.DT2U,COLS.DT2A,COLS.DT3TZ,COLS.DT3,COLS.DT3NTZ,COLS.DT3N,COLS.DT3UTZ,COLS.DT3U,COLS.DT3ATZ,COLS.DT3A,COLS.DT4,COLS.DT4N,COLS.DT4U,COLS.DT4A,COLS.CREATED,COLS.LASTUPDATED,COLS.DELETED };
   ...
   protected static void initObject(Connection C) throws Exception
     {
       if (__INITIALIZED.compareAndSet(false, true))
        {
           tilda.data_test.TestingTimestamps_Cloned_Factory.init(C);
        }
     }
   private static class RecordProcessorInternal implements tilda.db.processors.RecordProcessor
     {
       public RecordProcessorInternal(Connection C, int start)
         {
           _C = C;
           _L = new ArrayListResults<tilda.data_test.TestingTimestamps_Cloned_Data>(start);
         }
       public RecordProcessorInternal(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.TestingTimestamps_Cloned_Data> OP)
         {
           _C = C;
           _OP = OP;
         }
       protected Connection _C = null;
       protected tilda.db.processors.ObjectProcessor<tilda.data_test.TestingTimestamps_Cloned_Data> _OP;
       protected ArrayListResults<tilda.data_test.TestingTimestamps_Cloned_Data> _L = null;
       public void    start  ()                              throws Exception { if (_OP != null) _OP.start(); }
       public void    end    (boolean hasMore, int maxCount) throws Exception { if (_OP == null) _L.wrapup(hasMore, maxCount); else _OP.end(hasMore, maxCount); }
       public boolean process(int count, java.sql.ResultSet RS) throws Exception
        {
          tilda.data_test.TestingTimestamps_Cloned_Data Obj = new tilda.data_test.TestingTimestamps_Cloned_Data();
          boolean OK = ((tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED)Obj).init(_C, RS);
          if (OK == true)
           {
             if (_OP == null)
              _L.add(Obj);
   ...
   protected static final ListResults<tilda.data_test.TestingTimestamps_Cloned_Data> readMany(Connection C, String fullSelectQuery, int start, int size) throws Exception
     {
   ...
   private static final void readMany(Connection C, int LookupId, tilda.db.processors.RecordProcessor RP, tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj, Object ExtraParams, int start, int size) throws Exception
     {
       ...
       QueryDetails.logQuery("TILDATEST.TestingTimestamps_Cloned", Q, null);
...
*/
   static public tilda.data_test.TestingTimestamps_Cloned_Data init(Map<String, String[]> Values, List<StringStringPair> Errors)
   throws Exception
     {
...
*/
   static public tilda.data_test.TestingTimestamps_Cloned_Data create(String id) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj = new tilda.data_test.TestingTimestamps_Cloned_Data();
       Obj.initForCreate();
       ...
       // Auto PK
       Obj.setRefnum(tilda.db.KeysManager.getKey("TILDATEST.TESTINGTIMESTAMPS_CLONED"));
       ...
       // Default Nullables
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT1._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT1A._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT2._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT2A._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT3._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT3A._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT4._Mask);
       Obj.__Nulls.or(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.COLS.DT4A._Mask);

       return (tilda.data_test.TestingTimestamps_Cloned_Data) Obj;
     }

   public static int writeBatch(Connection C, List<tilda.data_test.TestingTimestamps_Cloned_Data> L, int batchSize, int commitSize) throws Exception
     {
       long T0 = System.nanoTime();
       ...
       int count = 0;
       int batchStart = 0;
       TILDA__TESTINGTIMESTAMPS_CLONED lastObj = null;
       BitSet firstChangeList = (BitSet) ((TILDA__TESTINGTIMESTAMPS_CLONED) L.get(0)).__Changes.clone();
       String firstTimeStampSignature = ((TILDA__TESTINGTIMESTAMPS_CLONED) L.get(0)).getTimeStampSignature();
       ...
       try
         {
           ...
           int index = -1;
           for (tilda.data_test.TestingTimestamps_Cloned_Data d : L)
             {
               ++index;
               if (d == null || d.hasChanged() == false)
                 continue;

               lastObj = ((TILDA__TESTINGTIMESTAMPS_CLONED) d);

               if (((TILDA__TESTINGTIMESTAMPS_CLONED) d).__Init != InitMode.CREATE)
                 {
                   LOG.debug(QueryDetails._LOGGING_HEADER + "The 'tilda.data_test.TestingTimestamps_Cloned_Data' object at positon #" + index + " was not in an insertable state. Only inserts are allowed in batch writes (i.e., no updates).");
                   QueryDetails.setLastQuery(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, "");
                   return index;
                 }


               if (((TILDA__TESTINGTIMESTAMPS_CLONED) d).beforeWrite(C) == false)
                 {
                   LOG.debug(QueryDetails._LOGGING_HEADER + "The 'tilda.data_test.TestingTimestamps_Cloned_Data' object at positon #" + index + " failed in its beforeWrite() method.");
                   QueryDetails.setLastQuery(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, "");
                   return index;
                 }

               if (firstChangeList.equals(((TILDA__TESTINGTIMESTAMPS_CLONED) d).__Changes) == false)
                 {
                   LOG.debug(QueryDetails._LOGGING_HEADER + "The 'tilda.data_test.TestingTimestamps_Cloned_Data' object at positon #" + index + " failed matching the list of columns being changed compared to the first object passed.");
                   QueryDetails.setLastQuery(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, "");
                   return index;
                 }

               if (firstTimeStampSignature.equals(((TILDA__TESTINGTIMESTAMPS_CLONED) d).getTimeStampSignature()) == false)
                 {
                   LOG.debug(QueryDetails._LOGGING_HEADER + "The 'tilda.data_test.TestingTimestamps_Cloned_Data' object at positon #" + index + " failed matching the list of updated current vs value based timestamps.");
                   QueryDetails.setLastQuery(TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, "");
                   return index;
                 }
               ...
               if (index != 0 && (index + 1) % batchSize == 0)
                 {
                   ...
                   if (failedRec != -1)
                     {
                       LOG.debug(QueryDetails._LOGGING_HEADER + "A batch of tilda.data_test.TestingTimestamps_Cloned_Data objects between positions #" + batchStart + " and #" + index + " failed being written to the database.");
           ...
           if ((index + 1) % batchSize != 0)
             {
               ...
               if (failedRec != -1)
                 {
                   LOG.debug(QueryDetails._LOGGING_HEADER + "A batch of 'TestingTimestamps_Cloned_Data' objects ending at position #" + index + " failed being written to the database.");
         ...
         {
           TILDA__2_5.handleFinally(PS, T0, TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
           AllocatedArrays = null;
         }
       }
...
*/
   static public tilda.data_test.TestingTimestamps_Cloned_Data lookupByPrimaryKey(long refnum) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj = new tilda.data_test.TestingTimestamps_Cloned_Data();
       Obj.initForLookup(0);
...
Lookup records by the index 'AllByName' over  .<BR>The results are ordered by: id asc
*/
   static public void lookupWhereAllByName(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.TestingTimestamps_Cloned_Data> OP, int __start__, int __size__) throws Exception
     {
       tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj = new tilda.data_test.TestingTimestamps_Cloned_Data();
       Obj.initForLookup(tilda.utils.SystemValues.EVIL_VALUE);
...
*/   static public void lookupWhereAll(Connection C, tilda.db.processors.ObjectProcessor<tilda.data_test.TestingTimestamps_Cloned_Data> OP, int start, int size) throws Exception
   ...
   public static ListResults<tilda.data_test.TestingTimestamps_Cloned_Data> runSelect(Connection C, SelectQuery Q, int start, int size) throws Exception
     {
       RecordProcessorInternal RPI = new RecordProcessorInternal(C, start);
   ...
   public static void runSelect(Connection C, SelectQuery Q, tilda.db.processors.ObjectProcessor<tilda.data_test.TestingTimestamps_Cloned_Data> OP, int start, int size) throws Exception
     {
       RecordProcessorInternal RPI = new RecordProcessorInternal(C, OP);
       if (Q.isFullSelectQuery() == true)
        readMany(C, -77, RPI, null, Q.toString(), start, size);
   ...
   public static void toJSONAAA(java.io.Writer out, List<tilda.data_test.TestingTimestamps_Cloned_Data> L, String lead, boolean fullList) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (fullList == true)
        {
      ...
      boolean First = true;
      for (tilda.data_test.TestingTimestamps_Cloned_Data O : L)
       if (O!=null)
        {
          out.write(lead);
   ...
   public static void toJSONAAA(java.io.Writer out, tilda.data_test.TestingTimestamps_Cloned_Data obj, boolean fullObject) throws java.io.IOException
    {
      toJSONAAA(out, obj, "", fullObject, false);
    }

   public static void toJSONAAA(java.io.Writer out, tilda.data_test.TestingTimestamps_Cloned_Data obj, String lead, boolean fullObject) throws java.io.IOException
    {
      toJSONAAA(out, obj, lead, fullObject, false);
    }

   public static void toJSONAAA(java.io.Writer outWriter, tilda.data_test.TestingTimestamps_Cloned_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      try(org.apache.commons.io.output.StringBuilderWriter out = new org.apache.commons.io.output.StringBuilderWriter())
       {
        tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj = (tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED) obj;
        if (fullObject == true)
         {
           out.write(lead);
           out.write("{");
      ...
      if (Obj.isNullRowTZ_TILDATEST_TestingTimestamps_Cloned() == false && Obj.getRowTZ_TILDATEST_TestingTimestamps_Cloned() != null)
        JSONUtil.print(out, "rowTZ_TILDATEST_TestingTimestamps_Cloned", ++i==0, Obj.getRowTZ_TILDATEST_TestingTimestamps_Cloned());
   ...
   public static String getCSVHeader()
    {
      return "\"refnum\",\"id\",\"dt1TZ\",\"dt1\",\"dt1nTZ\",\"dt1n\",\"dt1uTZ\",\"dt1u\",\"dt1aTZ\",\"dt1a\",\"rowTZ_TILDATEST_TestingTimestamps_Cloned\",\"dt2\",\"dt2n\",\"dt2u\",\"dt2a\",\"dt3TZ\",\"dt3\",\"dt3nTZ\",\"dt3n\",\"dt3uTZ\",\"dt3u\",\"dt3aTZ\",\"dt3a\",\"dt4\",\"dt4n\",\"dt4u\",\"dt4a\",\"created\",\"lastUpdated\",\"deleted\"";
    }

   public static void toCSV(java.io.Writer out, List<tilda.data_test.TestingTimestamps_Cloned_Data> L, boolean includeHeader) throws java.io.IOException
    {
      long T0 = System.nanoTime();
   ...
   public static void toCSV(java.io.Writer out, tilda.data_test.TestingTimestamps_Cloned_Data obj) throws java.io.IOException
    {
      long T0 = System.nanoTime();
     tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj = (tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED) obj;
      ...
      Str.append(",");
      TextUtil.escapeDoubleQuoteForCSV(Str, Obj.getRowTZ_TILDATEST_TestingTimestamps_Cloned());
      Str.append(",");
   ...
   public static void toJSON(java.io.Writer out, List<tilda.data_test.TestingTimestamps_Cloned_Data> L, String lead, boolean fullList) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      if (fullList == true)
        {
   ...
   public static void toJSON(java.io.Writer out, tilda.data_test.TestingTimestamps_Cloned_Data obj, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, "", fullObject, false);
    }

   public static void toJSON(java.io.Writer out, tilda.data_test.TestingTimestamps_Cloned_Data obj, String lead, boolean fullObject) throws java.io.IOException
    {
      toJSON(out, obj, lead, fullObject, false);
    }

   public static void toJSON(java.io.Writer outWriter, tilda.data_test.TestingTimestamps_Cloned_Data obj, String lead, boolean fullObject, boolean noNullArrays) throws java.io.IOException
    {
      long T0 = System.nanoTime();
      try(org.apache.commons.io.output.StringBuilderWriter out = new org.apache.commons.io.output.StringBuilderWriter())
       {
