...
*/
     public final Type_StringPrimitiveNull          ROWTZ      = new Type_StringPrimitiveNull         (SCHEMA_LABEL, TABLENAME_LABEL, "rowTZ"      , 10/*10*/, 5, "Generated helper column to hold the time zone ID for 1 or more columns at the TILDATEST.TestingTimestamps_Cloned row level: dt2, dt2n, dt2u, dt2a, dt4, dt4n, dt4u, dt4a.", null, null, null);
   ...
   private static final void readMany(Connection C, int LookupId, tilda.db.processors.RecordProcessor RP, tilda.data_test._Tilda.TILDA__TESTINGTIMESTAMPS_CLONED Obj, Object ExtraParams, int start, int size) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data_test._Tilda.TILDA__2_3.handleFinally(PS, T0, TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, StatementType.SELECT, count, AllocatedArrays);
          PS = null;
   ...
   public static int writeBatch(Connection C, List<tilda.data_test.TestingTimestamps_Cloned_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_3.handleFinally(PS, T0, TILDA__TESTINGTIMESTAMPS_CLONED_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
           AllocatedArrays = null;
         }
       }
