...
The Table TILDATEST.Form:<UL>
<LI>Is mapped to the generated Java 8/PostgreSQL Tilda classes <B>Form_Factory</B>, <B>Form_Data</B> in the package <B>tilda.data_test</B>.
<LI>Is configured for normal <B>read/write</B> access.</LI>
<LI>Is OCC-enabled. Default created/lastUpdated/deleted columns have been automatically generated.</LI>
<LI>Defines foreign key(s) to <A href="TILDA___Docs.TILDATEST.html#User_CNT">TILDATEST<B>&nbsp;&#8226;&nbsp;</B>User</A>, <A href="TILDA___Docs.TILDA.html#ZoneInfo_CNT">TILDA<B>&nbsp;&#8226;&nbsp;</B>ZoneInfo</A> </LI>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>The user who created the form<TABLE border="0px" style="margin:0px;margin-left:20px;font-size:75%;"><TR><TD><B style="color:white;background-color:fuchsia;">FK</B></TD><TD>&rarr;&nbsp;<A href="TILDA___Docs.TILDATEST.html#User_CNT">TILDATEST<B>&nbsp;&#8226;&nbsp;</B>User</A>: refnum</TD></TR>
</TABLE>
</TD>
</TR>
  <TR valign="top" bgcolor="#DFECF8">
...
<TD align="center">&#x2611;&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>The timestamp for when the record was created. (TILDATEST.Form)</TD>
</TR>
  <TR valign="top" bgcolor="#DFECF8">
    <TD>7&nbsp;&nbsp;</TD>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>The timestamp for when the record was last updated. (TILDATEST.Form)</TD>
</TR>
  <TR valign="top" bgcolor="#FFFFFF">
    <TD>8&nbsp;&nbsp;</TD>
...
<TD align="center">&#x2610&nbsp;&nbsp;</TD>
<TD align="center">-&nbsp;&nbsp;</TD>
<TD>The timestamp for when the record was deleted. (TILDATEST.Form)</TD>
</TR>
</TABLE></BLOCKQUOTE>
</DIV>
...
public abstract class TILDA__FORM implements tilda.interfaces.WriterObject, tilda.interfaces.OCCObject
 {
   protected static final Logger LOG = LogManager.getLogger(TILDA__FORM.class.getName());

   public static final Class<TILDA__FORM_Factory> FACTORY_CLASS= TILDA__FORM_Factory.class;
   public static final String TABLENAME = TextUtil.Print("TILDATEST.Form", "");
       ...
       if (__Init == InitMode.CREATE || v != _refnum)
        {
          if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
           throw new Exception("Cannot set field 'tilda.data_test.TILDATEST.Form.refnum' that is invariant, or part of a read-only or pre-existing WORM object.");
...
*/
   long _userRefnum= SystemValues.EVIL_VALUE;
...
*/
   public void setUserRefnum(long v) throws Exception
     {
       long T0 = System.nanoTime();
       if (__Init == InitMode.CREATE || v != _userRefnum)
        {
   ...
   public void setType(String v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Form.type to null: it's not nullable.");
       else if (v.length() > 40)
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Form.type: the value "+TextUtil.escapeDoubleQuoteWithSlash(v)+" is larger than the max size allowed 40.");
...
*/
   public final boolean isNullFillDateTZ()
    ...
    void setFillDateTZ(String v) throws Exception
     {
       ...
       if (v == null)
        ...
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Form.fillDateTZ: the value "+TextUtil.escapeDoubleQuoteWithSlash(v)+" is larger than the max size allowed 5.");
...
*/
   public final boolean isNullFillDate()
   ...
   public void setFillDate(ZonedDateTime v) throws Exception
     {
       ...
       _fillDate = v;
          ...
          if (ZI == null)
           throw new Exception("Cannot set field 'tilda.data_test.TILDATEST.Form.fillDate' because the timezone value '"+v.getZone().getId()+"' is unknown. Make sure it is mapped properly in the ZoneInfo table.");
...
*/
   public final void setFillDate(int year, int month, int date, int hourOfDay, int minute, int second, int millis, ZoneId z) throws Exception
    {
      setFillDate(DateTimeUtil.New(year, month, date, hourOfDay, minute, second, millis, z));
    }
    ...
    void setCreated(ZonedDateTime v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Form.created to null: it's not nullable.");
       else if (v.equals(_created) == false)
        {
          if (__Init != InitMode.CREATE && __Init != InitMode.LOOKUP)
           throw new Exception("Cannot set field 'tilda.data_test.TILDATEST.Form.created' that is invariant, or part of a read-only or pre-existing WORM object.");
   ...
   public final void setLastUpdated(ZonedDateTime v) throws Exception
     {
       long T0 = System.nanoTime();
       if (v == null)
        throw new Exception("Cannot set tilda.data_test.TILDATEST.Form.lastUpdated to null: it's not nullable.");
...
*/
   public void CopyTo(tilda.data_test._Tilda.TILDA__FORM Dst) throws Exception
     {
       Dst.setUserRefnum (_userRefnum );
       Dst.setType       (_type       );
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.FILLDATETZ._Mask) == true) Dst.setNullFillDateTZ (); else        Dst.setFillDateTZ (_fillDateTZ );
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.FILLDATE._Mask) == true) Dst.setNullFillDate   (); else        Dst.setFillDate   (_fillDate   );
       Dst.setLastUpdated(_lastUpdated);
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.DELETED._Mask) == true) Dst.setNullDeleted    (); else        Dst.setDeleted    (_deleted    );
     }
   ...
   protected String getWriteQuery(Connection C) throws Exception
     {
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          S.append("insert into "); C.getFullTableVar(S, "TILDATEST", "Form");
          int Pos = S.length();
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.REFNUM._Mask) == true) { TILDA__FORM_Factory.COLS.REFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.USERREFNUM._Mask) == true) { TILDA__FORM_Factory.COLS.USERREFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.TYPE._Mask) == true) { TILDA__FORM_Factory.COLS.TYPE.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.FILLDATETZ._Mask) == true) { TILDA__FORM_Factory.COLS.FILLDATETZ.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.FILLDATE._Mask) == true) { TILDA__FORM_Factory.COLS.FILLDATE.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORM_Factory.COLS.FILLDATE._Mask) == false && DateTimeUtil.isNowPlaceholder(_fillDate) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.CREATED._Mask) == true) { TILDA__FORM_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORM_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__FORM_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORM_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__FORM_Factory.COLS.DELETED._Mask) == true) { TILDA__FORM_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__FORM_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__1_0._COMMAQUESTION);
           }
        ...
        {
          S.append("update "); C.getFullTableVar(S, "TILDATEST", "Form"); S.append(" set");
          int Pos = S.length();
          ...
          switch (__LookupId)
           {
             case 0:
                S.append(" where ("); C.getFullColumnVar(S, "TILDATEST", "Form", "refnum"); S.append("=?)");
                break;
             case -77: 
       ...
       QueryDetails.logQuery("TILDATEST.Form", Q, toString());
   ...
   protected int populatePreparedStatement(Connection C, java.sql.PreparedStatement PS, List<java.sql.Array> AllocatedArrays) throws Exception
     {
       ...
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.FILLDATE._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORM_Factory.COLS.FILLDATE._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_fillDate) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_fillDate.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.CREATED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORM_Factory.COLS.CREATED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_created) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_created.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.LASTUPDATED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORM_Factory.COLS.LASTUPDATED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_lastUpdated) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_lastUpdated.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       if (__Changes.intersects(TILDA__FORM_Factory.COLS.DELETED._Mask) == true) 
        { 
          if (__Nulls.intersects(TILDA__FORM_Factory.COLS.DELETED._Mask) == true) PS.setNull(++i, java.sql.Types.TIMESTAMP_WITH_TIMEZONE); else if (DateTimeUtil.isNowPlaceholder(_deleted) == false) PS.setTimestamp(++i, new java.sql.Timestamp(_deleted.toInstant().toEpochMilli()), DateTimeUtil._UTC_CALENDAR);
        } 
       return i;
     }
   ...
   public final boolean Write(Connection C) throws Exception
     {
       ...
       if (hasChanged() == false)
        {
          LOG.debug(QueryDetails._LOGGING_HEADER + "The tilda.data_test.TILDATEST.Form has not changed: no writing will occur.");
       ...
       if (BeforeWrite(C) == false)
        {
          LOG.debug(QueryDetails._LOGGING_HEADER + "The tilda.data_test.TILDATEST.Form object's BeforeWrite() failed.");
          QueryDetails.setLastQuery(TILDA__FORM_Factory.SCHEMA_TABLENAME_LABEL, "");
          return false;
        }
       ...
       try
        ...
        {
          tilda.data_test._Tilda.TILDA__1_0.HandleFinally(PS, T0, TILDA__FORM_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, null);
          PS = null;
        }
   ...
   private final boolean ReadOne(Connection C, boolean Force) throws Exception
     {
       long T0 = System.nanoTime();
       if (__Init == InitMode.CREATE)
        throw new Exception("This TILDATEST.Form object is being Read() after a Create(), which doesn't make sense.");
       if (__Init == InitMode.READ == true && Force == false && hasChanged()==false)
        {
          LOG.debug(QueryDetails._LOGGING_HEADER + "This TILDATEST.Form object has already been read.");
          QueryDetails.setLastQuery(TILDA__FORM_Factory.SCHEMA_TABLENAME_LABEL, "");
          return true;
        }
       StringBuilder S = new StringBuilder(1024);
   ...
   boolean Init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      __Saved_refnum      = _refnum      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) __Nulls.or(TILDA__FORM_Factory.COLS.REFNUM._Mask     );
                            ...
                            _fillDate    = ProcessZDT(_fillDateTZ   , "tilda.data_test.TILDATEST.Form.fillDate"   , RS, ++i, TILDA__FORM_Factory.COLS.FILLDATE   , TILDA__FORM_Factory.COLS.FILLDATETZ   ); if (RS.wasNull() == true) __Nulls.or(TILDA__FORM_Factory.COLS.FILLDATE._Mask   );
