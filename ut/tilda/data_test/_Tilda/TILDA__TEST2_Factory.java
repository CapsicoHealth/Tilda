   ...
   public static int writeBatch(Connection C, List<tilda.data_test.Test2_Data> L, int batchSize, int commitSize) throws Exception
     {
       ...
       try
         ...
         {
           TILDA__2_5.handleFinally(PS, T0, TILDA__TEST2_Factory.SCHEMA_TABLENAME_LABEL, lastObj != null && lastObj.__Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
           PS = null;
