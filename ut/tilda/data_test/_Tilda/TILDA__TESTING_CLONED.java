...
*/
   public void copyTo(tilda.data_test._Tilda.TILDA__TESTING_CLONED Dst) throws Exception
     {
       Dst.setName       (_name       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESCRIPTION._Mask) == true) Dst.setDescriptionNull(); else        Dst.setDescription(_description);
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC2._Mask) == true) Dst.setDesc2Null      (); else        Dst.setDesc2      (_desc2      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC3._Mask) == true) Dst.setDesc3Null      (); else        Dst.setDesc3      (_desc3      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC4._Mask) == true) Dst.setDesc4Null      (); else        Dst.setDesc4      (_desc4      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC5._Mask) == true) Dst.setDesc5Null      (); else        Dst.setDesc5      (_desc5      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC6._Mask) == true) Dst.setDesc6Null      (); else        Dst.setDesc6      (_desc6      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.TOPS._Mask) == true) Dst.setTopsNull       (); else        Dst.setTops       (_tops       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.TOPS2._Mask) == true) Dst.setTops2Null      (); else        Dst.setTops2      (_tops2      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A1._Mask) == true) Dst.setA1Null         (); else        Dst.setA1         (_a1         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A2._Mask) == true) Dst.setA2Null         (); else        Dst.setA2         (_a2         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A2B._Mask) == true) Dst.setA2bNull        (); else        Dst.setA2b        (_a2b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A2C._Mask) == true) Dst.setA2cNull        (); else        Dst.setA2c        (_a2c        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A3._Mask) == true) Dst.setA3Null         (); else        Dst.setA3         (_a3         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A3B._Mask) == true) Dst.setA3bNull        (); else        Dst.setA3b        (_a3b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A4._Mask) == true) Dst.setA4Null         (); else        Dst.setA4         (_a4         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A4B._Mask) == true) Dst.setA4bNull        (); else        Dst.setA4b        (_a4b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A5._Mask) == true) Dst.setA5Null         (); else        Dst.setA5         (_a5         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A5B._Mask) == true) Dst.setA5bNull        (); else        Dst.setA5b        (_a5b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6._Mask) == true) Dst.setA6Null         (); else        Dst.setA6         (_a6         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6B._Mask) == true) Dst.setA6bNull        (); else        Dst.setA6b        (_a6b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6C._Mask) == true) Dst.setA6cNull        (); else        Dst.setA6c        (_a6c        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6DTZ._Mask) == true) Dst.setA6dTZNull      (); else        Dst.setA6dTZ      (_a6dTZ      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6D._Mask) == true) Dst.setA6dNull        (); else        Dst.setA6d        (_a6d        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A7._Mask) == true) Dst.setA7Null         (); else        Dst.setA7         (_a7         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A7B._Mask) == true) Dst.setA7bNull        (); else        Dst.setA7b        (_a7b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A8._Mask) == true) Dst.setA8Null         (); else        Dst.setA8         (_a8         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A8BTZ._Mask) == true) Dst.setA8bTZNull      (); else        Dst.setA8bTZ      (_a8bTZ      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A8B._Mask) == true) Dst.setA8bNull        (); else        Dst.setA8b        (_a8b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9TZ._Mask) == true) Dst.setA9TZNull       (); else        Dst.setA9TZ       (_a9TZ       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9._Mask) == true) Dst.setA9Null         (); else        Dst.setA9         (_a9         );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9A1TZ._Mask) == true) Dst.setA9a1TZNull     (); else        Dst.setA9a1TZ     (_a9a1TZ     );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9A1._Mask) == true) Dst.setA9a1Null       (); else        Dst.setA9a1       (_a9a1       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9BTZ._Mask) == true) Dst.setA9bTZNull      (); else        Dst.setA9bTZ      (_a9bTZ      );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9B._Mask) == true) Dst.setA9bNull        (); else        Dst.setA9b        (_a9b        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9C._Mask) == true) Dst.setA9cNull        (); else        Dst.setA9c        (_a9c        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9D._Mask) == true) Dst.setA9dNull        (); else        Dst.setA9d        (_a9d        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A10A._Mask) == true) Dst.setA10aNull       (); else        Dst.setA10a       (_a10a       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A10B._Mask) == true) Dst.setA10bNull       (); else        Dst.setA10b       (_a10b       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A10C._Mask) == true) Dst.setA10cNull       (); else        Dst.setA10c       (_a10c       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A11._Mask) == true) Dst.setA11Null        (); else        Dst.setA11        (_a11        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A11B._Mask) == true) Dst.setA11bNull       (); else        Dst.setA11b       (_a11b       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A11C._Mask) == true) Dst.setA11cNull       (); else        Dst.setA11c       (_a11c       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A12._Mask) == true) Dst.setA12Null        (); else        Dst.setA12        (_a12        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A12B._Mask) == true) Dst.setA12bNull       (); else        Dst.setA12b       (_a12b       );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A13._Mask) == true) Dst.setA13Null        (); else        Dst.setA13        (_a13        );
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A13B._Mask) == true) Dst.setA13bNull       (); else        Dst.setA13b       (_a13b       );
       Dst.setLastUpdated(_lastUpdated);
       if (__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DELETED._Mask) == true) Dst.setDeletedNull    (); else        Dst.setDeleted    (_deleted    );
     }
   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      __Saved_refnum      = _refnum      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.REFNUM._Mask     ); _refnum = null; }
                            ...
                            _a8          =                              RS.getBytes     (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A8._Mask         ); _a8 = null; }
