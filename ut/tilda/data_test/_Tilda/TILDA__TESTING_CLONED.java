   ...
   boolean init(Connection C, java.sql.ResultSet RS) throws Exception
    {
     ...
     __Init = InitMode.LOOKUP;
      __Saved_refnum      = _refnum      =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.REFNUM._Mask     ); _refnum = null; }
                            _refnum2 = (List<Long>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.REFNUM2._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.REFNUM2._Mask    ); _refnum2 = null; }
                            ...
                            _tops = (List<String>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.TOPS._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.TOPS._Mask       ); _tops = null; }
                            _tops2 = (Set<String>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.TOPS2._Type, true); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.TOPS2._Mask      ); _tops2 = null; }
                            ...
                            _a2b = (List<Character>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A2B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A2B._Mask        ); _a2b = null; }
                            _a2c = (Set<Character>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A2C._Type, true); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A2C._Mask        ); _a2c = null; }
                            _a3          =                              RS.getBoolean   (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A3._Mask         ); _a3 = null; }
                            _a3b = (List<Boolean>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A3B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A3B._Mask        ); _a3b = null; }
                            _a4          =                              RS.getDouble    (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A4._Mask         ); _a4 = null; }
                            _a4b = (List<Double>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A4B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A4B._Mask        ); _a4b = null; }
                            _a5          =                              RS.getFloat     (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A5._Mask         ); _a5 = null; }
                            _a5b = (List<Float>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A5B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A5B._Mask        ); _a5b = null; }
                            _a6          =                              RS.getLong      (++i) ;  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6._Mask         ); _a6 = null; }
                            _a6b = (List<Long>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A6B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6B._Mask        ); _a6b = null; }
                            _a6c = (Set<Long>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A6C._Type, true); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A6C._Mask        ); _a6c = null; }
                            ...
                            _a7b = (List<Integer>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A7B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A7B._Mask        ); _a7b = null; }
                            ...
                            _a9bTZ = (List<String>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A9BTZ._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A9BTZ._Mask      ); _a9bTZ = null; }
                            ...
                            _a9d         = DateTimeUtil.toLocalDates((List<java.sql.Date>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A9D._Type, false)); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A9D._Mask        ); _a9d = null; }
                            ...
                            _a11b = (List<BigDecimal>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A11B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A11B._Mask       ); _a11b = null; }
                            ...
                            _a12b = (List<Short>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A12B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A12B._Mask       ); _a12b = null; }
                            _a13         =                              (java.util.UUID) RS.getObject(++i);  if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A13._Mask        ); _a13 = null; }
                            _a13b = (List<UUID>) C.getArray(RS, ++i, TILDA__TESTING_CLONED_Factory.COLS.A13B._Type, false); if (RS.wasNull() == true) { __Nulls.or(TILDA__TESTING_CLONED_Factory.COLS.A13B._Mask       ); _a13b = null; }
