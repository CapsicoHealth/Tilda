   ...
   public final boolean write(Connection C) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data_test._Tilda.TILDA__2_5.handleFinally(PS, T0, TILDA__TESTING_CLONED_Factory.SCHEMA_TABLENAME_LABEL, __Init == InitMode.CREATE ? StatementType.INSERT : StatementType.UPDATE, count, AllocatedArrays);
          PS = null;
       ...
       if (__Init == InitMode.CREATE)
        {
          ...
          int Pos = S.length();
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.REFNUM._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.REFNUM.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.REFNUM2._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.REFNUM2.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.NAME._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.NAME.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESCRIPTION._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.DESCRIPTION.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC2._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.DESC2.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC3._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.DESC3.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC4._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.DESC4.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.DESC5._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.DESC5.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A3._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A3.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A3B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A3B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A4._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A4.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A4B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A4B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A5._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A5.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A5B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A5B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A6.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A6B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6C._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A6C.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6DTZ._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A6DTZ.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6D._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A6D.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A6D._Mask) == false && DateTimeUtil.isNowPlaceholder(_a6d) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A7._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A7.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A7B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A7B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A8BTZ._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A8BTZ.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A8B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A8B.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A8B._Mask) == false && DateTimeUtil.isNowPlaceholder(_a8b) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9TZ._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A9TZ.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A9.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9._Mask) == false && DateTimeUtil.isNowPlaceholder(_a9) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          else { TILDA__TESTING_CLONED_Factory.COLS.A9.getFullColumnVarForInsert(C, S); V.append(C.getCommaCurrentTimestamp()); }          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9A1TZ._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A9A1TZ.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9A1._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A9A1.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9A1._Mask) == false && DateTimeUtil.isNowPlaceholder(_a9a1) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          else { TILDA__TESTING_CLONED_Factory.COLS.A9A1.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION); }          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A9BTZ._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A9BTZ.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A10A._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A10A.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A10B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A10B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A10C._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A10C.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A11._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A11.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A11B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A11B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A11C._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A11C.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A12._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A12.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A12B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A12B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A13._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A13.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.A13B._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.A13B.getFullColumnVarForInsert(C, S); V.append(tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);  }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.CREATED._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.CREATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.CREATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_created) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.LASTUPDATED._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.LASTUPDATED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.LASTUPDATED._Mask) == false && DateTimeUtil.isNowPlaceholder(_lastUpdated) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
          ...
          if (__Changes.intersects(TILDA__TESTING_CLONED_Factory.COLS.DELETED._Mask) == true) { TILDA__TESTING_CLONED_Factory.COLS.DELETED.getFullColumnVarForInsert(C, S);
             V.append(__Nulls.intersects(TILDA__TESTING_CLONED_Factory.COLS.DELETED._Mask) == false && DateTimeUtil.isNowPlaceholder(_deleted) == true ? C.getCommaCurrentTimestamp() : tilda.data_test._Tilda.TILDA__2_5._COMMAQUESTION);
           }
   ...
   private final boolean readOne(Connection C, boolean Force) throws Exception
     {
       ...
       try
        ...
        {
          tilda.data_test._Tilda.TILDA__2_5.handleFinally(PS, T0, TILDA__TESTING_CLONED_Factory.SCHEMA_TABLENAME_LABEL, StatementType.SELECT, count, AllocatedArrays);
          PS = null;
          AllocatedArrays = null;
        }
    }
